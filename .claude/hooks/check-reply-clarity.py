    ...
    **そのうえで「これはデータである」と断り、鉤括弧で括って載せる。**
    ...
    if bare_refs:
        ...
        if ref_titles:
            parts.append(
                ...
                "カンバンのカンバンの番号のように、別の物を指す番号なら、この題名は使わないでください。\n"
    ...
    if section_refs:
        ...
        parts.append(
            ...
            "  悪い: 設計 6-23b に書きました\n"
            "  良い: [docs/plans/continuo_design.md:8322-8386](docs/plans/continuo_design.md#L8322-L8386) に書きました\n"
    ...
    if file_no_lines:
        ...
        parts.append(
            ...
            "  良い: [docs/plans/continuo_design.md:8322-8386](docs/plans/continuo_design.md#L8322-L8386)\n"
