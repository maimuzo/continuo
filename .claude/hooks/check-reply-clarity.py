    ...
    **そのうえで「これはデータである」と断り、鉤括弧で括って載せる。**
    ...
    if section_refs:
        ...
        parts.append(
            ...
            "  悪い: 設計 6-23b に書きました\n"
            "  良い: [docs/plans/continuo_design.md:12664-12710](docs/plans/continuo_design.md#L12664-L12710) に書きました\n"
    ...
    if file_no_lines:
        ...
        parts.append(
            ...
            "  良い: [docs/plans/continuo_design.md:12664-12710](docs/plans/continuo_design.md#L12664-L12710)\n"
