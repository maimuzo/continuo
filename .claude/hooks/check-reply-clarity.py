...
def build_reason(bare_refs, no_category, thin_quote, late_blocks, section_refs=0, file_no_lines=0, file_backtick=0, qchars=0) -> str:
    ...
    if section_refs:
        ...
        parts.append(
            ...
            "  悪い: 設計 6-23b に書きました\n"
            "  良い: [docs/plans/continuo_design.md:8287-8319](docs/plans/continuo_design.md#L8287-L8319) に書きました\n"
    ...
    if file_no_lines:
        ...
        parts.append(
            ...
            "  良い: [docs/plans/continuo_design.md:8287-8319](docs/plans/continuo_design.md#L8287-L8319)\n"
