...
case(
    ...
    base("**[docs/plans/continuo_design.md:12664-12710](docs/plans/continuo_design.md#L12664-L12710) に書きました。**"),
    False,
)
case(
...
case(
    "行番号があれば通る",
    base("[docs/plans/continuo_design.md:12664-12710](docs/plans/continuo_design.md#L12664-L12710) を見てください。"),
    False,
)
case(
