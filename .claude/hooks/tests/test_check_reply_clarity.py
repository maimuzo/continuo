...
case(
    ...
    base("**[docs/plans/continuo_design.md:12692-12738](docs/plans/continuo_design.md#L12692-L12738) に書きました。**"),
    False,
)
case(
...
case(
    "行番号があれば通る",
    base("[docs/plans/continuo_design.md:12692-12738](docs/plans/continuo_design.md#L12692-L12738) を見てください。"),
    False,
)
case(
