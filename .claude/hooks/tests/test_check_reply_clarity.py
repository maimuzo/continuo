...
case(
    ...
    base("**[docs/plans/continuo_design.md:12746-12792](docs/plans/continuo_design.md#L12746-L12792) に書きました。**"),
    False,
)
case(
...
case(
    "行番号があれば通る",
    base("[docs/plans/continuo_design.md:12746-12792](docs/plans/continuo_design.md#L12746-L12792) を見てください。"),
    False,
)
case(
