...
（載せることと Status は [docs/plans/continuo_design.md:9030](../../docs/plans/continuo_design.md#L9030)、
並べ替えは [docs/plans/continuo_design.md:9217-9221](../../docs/plans/continuo_design.md#L9217-L9221) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9036](../../docs/plans/continuo_design.md#L9036)）。
...
（[docs/plans/continuo_design.md:9028-9040](../../docs/plans/continuo_design.md#L9028-L9040)）。
...
（[docs/plans/continuo_design.md:9031](../../docs/plans/continuo_design.md#L9031) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9074](../../docs/plans/continuo_design.md#L9074) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9076](../../docs/plans/continuo_design.md#L9076)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9032](../../docs/plans/continuo_design.md#L9032) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9076](../../docs/plans/continuo_design.md#L9076)）。
