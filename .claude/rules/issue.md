...
（載せることと Status は [docs/plans/continuo_design.md:9699](../../docs/plans/continuo_design.md#L9699)、
並べ替えは [docs/plans/continuo_design.md:9886-9890](../../docs/plans/continuo_design.md#L9886-L9890) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9705](../../docs/plans/continuo_design.md#L9705)）。
...
（[docs/plans/continuo_design.md:9697-9709](../../docs/plans/continuo_design.md#L9697-L9709)）。
...
（[docs/plans/continuo_design.md:9700](../../docs/plans/continuo_design.md#L9700) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9743](../../docs/plans/continuo_design.md#L9743) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9745](../../docs/plans/continuo_design.md#L9745)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9701](../../docs/plans/continuo_design.md#L9701) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9745](../../docs/plans/continuo_design.md#L9745)）。
