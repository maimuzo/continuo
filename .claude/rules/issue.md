...
（載せることと Status は [docs/plans/continuo_design.md:9558](../../docs/plans/continuo_design.md#L9558)、
並べ替えは [docs/plans/continuo_design.md:9745-9749](../../docs/plans/continuo_design.md#L9745-L9749) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9564](../../docs/plans/continuo_design.md#L9564)）。
...
（[docs/plans/continuo_design.md:9556-9568](../../docs/plans/continuo_design.md#L9556-L9568)）。
...
（[docs/plans/continuo_design.md:9559](../../docs/plans/continuo_design.md#L9559) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9602](../../docs/plans/continuo_design.md#L9602) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9604](../../docs/plans/continuo_design.md#L9604)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9560](../../docs/plans/continuo_design.md#L9560) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9604](../../docs/plans/continuo_design.md#L9604)）。
