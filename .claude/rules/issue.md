...
（載せることと Status は [docs/plans/continuo_design.md:8711](../../docs/plans/continuo_design.md#L8711)、
並べ替えは [docs/plans/continuo_design.md:8898-8902](../../docs/plans/continuo_design.md#L8898-L8902) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8717](../../docs/plans/continuo_design.md#L8717)）。
...
（[docs/plans/continuo_design.md:8709-8721](../../docs/plans/continuo_design.md#L8709-L8721)）。
...
（[docs/plans/continuo_design.md:8712](../../docs/plans/continuo_design.md#L8712) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8755](../../docs/plans/continuo_design.md#L8755) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8757](../../docs/plans/continuo_design.md#L8757)）。104件の全並べ替えで約2分かかる |
...
| **グループごとの計画** | **そのグループの代表の issue のコメントへ残す**（[docs/plans/continuo_design.md:3534](../../docs/plans/continuo_design.md#L3534) の 3-26） |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8713](../../docs/plans/continuo_design.md#L8713) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
[docs/plans/continuo_design.md:3557-3558](../../docs/plans/continuo_design.md#L3557-L3558) の 3-26 が
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8757](../../docs/plans/continuo_design.md#L8757)）。
