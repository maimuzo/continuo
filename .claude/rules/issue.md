...
（載せることと Status は [docs/plans/continuo_design.md:9422](../../docs/plans/continuo_design.md#L9422)、
並べ替えは [docs/plans/continuo_design.md:9609-9613](../../docs/plans/continuo_design.md#L9609-L9613) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9428](../../docs/plans/continuo_design.md#L9428)）。
...
（[docs/plans/continuo_design.md:9420-9432](../../docs/plans/continuo_design.md#L9420-L9432)）。
...
（[docs/plans/continuo_design.md:9423](../../docs/plans/continuo_design.md#L9423) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9466](../../docs/plans/continuo_design.md#L9466) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9468](../../docs/plans/continuo_design.md#L9468)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9424](../../docs/plans/continuo_design.md#L9424) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9468](../../docs/plans/continuo_design.md#L9468)）。
