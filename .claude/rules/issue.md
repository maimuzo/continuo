...
（載せることと Status は [docs/plans/continuo_design.md:9256](../../docs/plans/continuo_design.md#L9256)、
並べ替えは [docs/plans/continuo_design.md:9443-9447](../../docs/plans/continuo_design.md#L9443-L9447) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9262](../../docs/plans/continuo_design.md#L9262)）。
...
（[docs/plans/continuo_design.md:9254-9266](../../docs/plans/continuo_design.md#L9254-L9266)）。
...
（[docs/plans/continuo_design.md:9257](../../docs/plans/continuo_design.md#L9257) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9300](../../docs/plans/continuo_design.md#L9300) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9302](../../docs/plans/continuo_design.md#L9302)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9258](../../docs/plans/continuo_design.md#L9258) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9302](../../docs/plans/continuo_design.md#L9302)）。
