...
（載せることと Status は [docs/plans/continuo_design.md:9164](../../docs/plans/continuo_design.md#L9164)、
並べ替えは [docs/plans/continuo_design.md:9353-9357](../../docs/plans/continuo_design.md#L9353-L9357) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9170](../../docs/plans/continuo_design.md#L9170)）。
...
（[docs/plans/continuo_design.md:9162-9174](../../docs/plans/continuo_design.md#L9162-L9174)）。
...
（[docs/plans/continuo_design.md:9165](../../docs/plans/continuo_design.md#L9165) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9210](../../docs/plans/continuo_design.md#L9210) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9212](../../docs/plans/continuo_design.md#L9212)）。104件の全並べ替えで約2分かかる |
...
| **グループごとの計画** | **そのグループの代表の issue のコメントへ残す**（[docs/plans/continuo_design.md:3580](../../docs/plans/continuo_design.md#L3580) の 3-26） |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9166](../../docs/plans/continuo_design.md#L9166) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
[docs/plans/continuo_design.md:3603-3604](../../docs/plans/continuo_design.md#L3603-L3604) の 3-26 が
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9212](../../docs/plans/continuo_design.md#L9212)）。
