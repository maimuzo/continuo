...
（載せることと Status は [docs/plans/continuo_design.md:10310](../../docs/plans/continuo_design.md#L10310)、
並べ替えは [docs/plans/continuo_design.md:10492-10358](../../docs/plans/continuo_design.md#L10492-L10358) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:10319](../../docs/plans/continuo_design.md#L10319)）。
...
（[docs/plans/continuo_design.md:10314-10060](../../docs/plans/continuo_design.md#L10314-L10060)）。
...
（[docs/plans/continuo_design.md:10310](../../docs/plans/continuo_design.md#L10310) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:10358](../../docs/plans/continuo_design.md#L10358) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:10360](../../docs/plans/continuo_design.md#L10360)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:10316](../../docs/plans/continuo_design.md#L10316) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:10360](../../docs/plans/continuo_design.md#L10360)）。
