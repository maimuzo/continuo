...
（載せることと Status は [docs/plans/continuo_design.md:8613](../../docs/plans/continuo_design.md#L8613)、
並べ替えは [docs/plans/continuo_design.md:8800-8804](../../docs/plans/continuo_design.md#L8800-L8804) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8619](../../docs/plans/continuo_design.md#L8619)）。
...
（[docs/plans/continuo_design.md:8611-8623](../../docs/plans/continuo_design.md#L8611-L8623)）。
...
（[docs/plans/continuo_design.md:8614](../../docs/plans/continuo_design.md#L8614) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8657](../../docs/plans/continuo_design.md#L8657) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8659](../../docs/plans/continuo_design.md#L8659)）。104件の全並べ替えで約2分かかる |
...
| **グループごとの計画** | **そのグループの代表の issue のコメントへ残す**（[docs/plans/continuo_design.md:3436](../../docs/plans/continuo_design.md#L3436) の 3-26） |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8615](../../docs/plans/continuo_design.md#L8615) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
[docs/plans/continuo_design.md:3459-3460](../../docs/plans/continuo_design.md#L3459-L3460) の 3-26 が
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8659](../../docs/plans/continuo_design.md#L8659)）。
