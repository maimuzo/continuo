...
（載せることと Status は [docs/plans/continuo_design.md:9301](../../docs/plans/continuo_design.md#L9301)、
並べ替えは [docs/plans/continuo_design.md:9488-9492](../../docs/plans/continuo_design.md#L9488-L9492) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9307](../../docs/plans/continuo_design.md#L9307)）。
...
（[docs/plans/continuo_design.md:9299-9311](../../docs/plans/continuo_design.md#L9299-L9311)）。
...
（[docs/plans/continuo_design.md:9302](../../docs/plans/continuo_design.md#L9302) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9345](../../docs/plans/continuo_design.md#L9345) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9347](../../docs/plans/continuo_design.md#L9347)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9303](../../docs/plans/continuo_design.md#L9303) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9347](../../docs/plans/continuo_design.md#L9347)）。
