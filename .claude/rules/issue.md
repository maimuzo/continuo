...
（載せることと Status は [docs/plans/continuo_design.md:8566](../../docs/plans/continuo_design.md#L8566)、
並べ替えは [docs/plans/continuo_design.md:8753-8757](../../docs/plans/continuo_design.md#L8753-L8757) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8572](../../docs/plans/continuo_design.md#L8572)）。
...
（[docs/plans/continuo_design.md:8564-8576](../../docs/plans/continuo_design.md#L8564-L8576)）。
...
（[docs/plans/continuo_design.md:8567](../../docs/plans/continuo_design.md#L8567) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8610](../../docs/plans/continuo_design.md#L8610) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8612](../../docs/plans/continuo_design.md#L8612)）。104件の全並べ替えで約2分かかる |
...
| **グループごとの計画** | **そのグループの代表の issue のコメントへ残す**（[docs/plans/continuo_design.md:3374](../../docs/plans/continuo_design.md#L3374) の 3-26） |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8568](../../docs/plans/continuo_design.md#L8568) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
[docs/plans/continuo_design.md:3397-3398](../../docs/plans/continuo_design.md#L3397-L3398) の 3-26 が
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8612](../../docs/plans/continuo_design.md#L8612)）。
