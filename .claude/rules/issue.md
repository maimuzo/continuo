...
（載せることと Status は [docs/plans/continuo_design.md:8579](../../docs/plans/continuo_design.md#L8579)、
並べ替えは [docs/plans/continuo_design.md:8766-8770](../../docs/plans/continuo_design.md#L8766-L8770) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8585](../../docs/plans/continuo_design.md#L8585)）。
...
（[docs/plans/continuo_design.md:8577-8589](../../docs/plans/continuo_design.md#L8577-L8589)）。
...
（[docs/plans/continuo_design.md:8580](../../docs/plans/continuo_design.md#L8580) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8623](../../docs/plans/continuo_design.md#L8623) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8625](../../docs/plans/continuo_design.md#L8625)）。104件の全並べ替えで約2分かかる |
...
| **グループごとの計画** | **そのグループの代表の issue のコメントへ残す**（[docs/plans/continuo_design.md:3402](../../docs/plans/continuo_design.md#L3402) の 3-26） |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8581](../../docs/plans/continuo_design.md#L8581) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
[docs/plans/continuo_design.md:3425-3426](../../docs/plans/continuo_design.md#L3425-L3426) の 3-26 が
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8625](../../docs/plans/continuo_design.md#L8625)）。
