...
（[internal/prompt/builtin.md:294](../../internal/prompt/builtin.md#L294) は「あなたが `gh` を叩く必要はありません」）。
...
組み込みの指示書（[internal/prompt/builtin.md:640-655](../../internal/prompt/builtin.md#L640-L655) の 7-2）が、
