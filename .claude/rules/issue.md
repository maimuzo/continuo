...
（載せることと Status は [docs/plans/continuo_design.md:8584](../../docs/plans/continuo_design.md#L8584)、
並べ替えは [docs/plans/continuo_design.md:8771-8775](../../docs/plans/continuo_design.md#L8771-L8775) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8590](../../docs/plans/continuo_design.md#L8590)）。
...
（[docs/plans/continuo_design.md:8582-8594](../../docs/plans/continuo_design.md#L8582-L8594)）。
...
（[docs/plans/continuo_design.md:8585](../../docs/plans/continuo_design.md#L8585) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8628](../../docs/plans/continuo_design.md#L8628) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8630](../../docs/plans/continuo_design.md#L8630)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8586](../../docs/plans/continuo_design.md#L8586) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8630](../../docs/plans/continuo_design.md#L8630)）。
