...
（載せることと Status は [docs/plans/continuo_design.md:9690](../../docs/plans/continuo_design.md#L9690)、
並べ替えは [docs/plans/continuo_design.md:9877-9881](../../docs/plans/continuo_design.md#L9877-L9881) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9696](../../docs/plans/continuo_design.md#L9696)）。
...
（[docs/plans/continuo_design.md:9688-9700](../../docs/plans/continuo_design.md#L9688-L9700)）。
...
（[docs/plans/continuo_design.md:9691](../../docs/plans/continuo_design.md#L9691) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9734](../../docs/plans/continuo_design.md#L9734) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9736](../../docs/plans/continuo_design.md#L9736)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9692](../../docs/plans/continuo_design.md#L9692) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9736](../../docs/plans/continuo_design.md#L9736)）。
