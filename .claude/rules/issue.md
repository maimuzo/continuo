...
（載せることと Status は [docs/plans/continuo_design.md:8925](../../docs/plans/continuo_design.md#L8925)、
並べ替えは [docs/plans/continuo_design.md:9112-9116](../../docs/plans/continuo_design.md#L9112-L9116) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8931](../../docs/plans/continuo_design.md#L8931)）。
...
（[docs/plans/continuo_design.md:8923-8935](../../docs/plans/continuo_design.md#L8923-L8935)）。
...
（[docs/plans/continuo_design.md:8926](../../docs/plans/continuo_design.md#L8926) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8969](../../docs/plans/continuo_design.md#L8969) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8971](../../docs/plans/continuo_design.md#L8971)）。104件の全並べ替えで約2分かかる |
...
| **グループごとの計画** | **そのグループの代表の issue のコメントへ残す**（[docs/plans/continuo_design.md:3539](../../docs/plans/continuo_design.md#L3539) の 3-26） |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8927](../../docs/plans/continuo_design.md#L8927) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
[docs/plans/continuo_design.md:3562-3563](../../docs/plans/continuo_design.md#L3562-L3563) の 3-26 が
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8971](../../docs/plans/continuo_design.md#L8971)）。
