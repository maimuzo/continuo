...
（載せることと Status は [docs/plans/continuo_design.md:9149](../../docs/plans/continuo_design.md#L9149)、
並べ替えは [docs/plans/continuo_design.md:9336-9340](../../docs/plans/continuo_design.md#L9336-L9340) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9155](../../docs/plans/continuo_design.md#L9155)）。
...
（[docs/plans/continuo_design.md:9147-9159](../../docs/plans/continuo_design.md#L9147-L9159)）。
...
（[docs/plans/continuo_design.md:9150](../../docs/plans/continuo_design.md#L9150) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9193](../../docs/plans/continuo_design.md#L9193) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9195](../../docs/plans/continuo_design.md#L9195)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9151](../../docs/plans/continuo_design.md#L9151) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9195](../../docs/plans/continuo_design.md#L9195)）。
