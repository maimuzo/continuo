...
（載せることと Status は [docs/plans/continuo_design.md:9679](../../docs/plans/continuo_design.md#L9679)、
並べ替えは [docs/plans/continuo_design.md:9866-9870](../../docs/plans/continuo_design.md#L9866-L9870) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9685](../../docs/plans/continuo_design.md#L9685)）。
...
（[docs/plans/continuo_design.md:9677-9689](../../docs/plans/continuo_design.md#L9677-L9689)）。
...
（[docs/plans/continuo_design.md:9680](../../docs/plans/continuo_design.md#L9680) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9723](../../docs/plans/continuo_design.md#L9723) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9725](../../docs/plans/continuo_design.md#L9725)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9681](../../docs/plans/continuo_design.md#L9681) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9725](../../docs/plans/continuo_design.md#L9725)）。
