...
（載せることと Status は [docs/plans/continuo_design.md:9152](../../docs/plans/continuo_design.md#L9152)、
並べ替えは [docs/plans/continuo_design.md:9339-9343](../../docs/plans/continuo_design.md#L9339-L9343) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9158](../../docs/plans/continuo_design.md#L9158)）。
...
（[docs/plans/continuo_design.md:9150-9162](../../docs/plans/continuo_design.md#L9150-L9162)）。
...
（[docs/plans/continuo_design.md:9153](../../docs/plans/continuo_design.md#L9153) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9196](../../docs/plans/continuo_design.md#L9196) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9198](../../docs/plans/continuo_design.md#L9198)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9154](../../docs/plans/continuo_design.md#L9154) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9198](../../docs/plans/continuo_design.md#L9198)）。
