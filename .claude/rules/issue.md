...
（載せることと Status は [docs/plans/continuo_design.md:10004](../../docs/plans/continuo_design.md#L10004)、
並べ替えは [docs/plans/continuo_design.md:10194-10198](../../docs/plans/continuo_design.md#L10194-L10198) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:10010](../../docs/plans/continuo_design.md#L10010)）。
...
（[docs/plans/continuo_design.md:10002-10014](../../docs/plans/continuo_design.md#L10002-L10014)）。
...
（[docs/plans/continuo_design.md:10005](../../docs/plans/continuo_design.md#L10005) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:10051](../../docs/plans/continuo_design.md#L10051) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:10053](../../docs/plans/continuo_design.md#L10053)）。104件の全並べ替えで約2分かかる |
...
| **グループごとの計画** | **そのグループの代表の issue のコメントへ残す**（[docs/plans/continuo_design.md:3585](../../docs/plans/continuo_design.md#L3585) の 3-26） |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:10006](../../docs/plans/continuo_design.md#L10006) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
[docs/plans/continuo_design.md:3608-3609](../../docs/plans/continuo_design.md#L3608-L3609) の 3-26 が
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:10053](../../docs/plans/continuo_design.md#L10053)）。
...
組み込みの指示書（[internal/prompt/builtin.md:611-626](../../internal/prompt/builtin.md#L611-L626) の 7-2）が、
