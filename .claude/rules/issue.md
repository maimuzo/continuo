...
（載せることと Status は [docs/plans/continuo_design.md:8972](../../docs/plans/continuo_design.md#L8972)、
並べ替えは [docs/plans/continuo_design.md:9159-9163](../../docs/plans/continuo_design.md#L9159-L9163) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8978](../../docs/plans/continuo_design.md#L8978)）。
...
（[docs/plans/continuo_design.md:8970-8982](../../docs/plans/continuo_design.md#L8970-L8982)）。
...
（[docs/plans/continuo_design.md:8973](../../docs/plans/continuo_design.md#L8973) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9016](../../docs/plans/continuo_design.md#L9016) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9018](../../docs/plans/continuo_design.md#L9018)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8974](../../docs/plans/continuo_design.md#L8974) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9018](../../docs/plans/continuo_design.md#L9018)）。
