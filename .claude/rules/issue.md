...
（載せることと Status は [docs/plans/continuo_design.md:8662](../../docs/plans/continuo_design.md#L8662)、
並べ替えは [docs/plans/continuo_design.md:8849-8853](../../docs/plans/continuo_design.md#L8849-L8853) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8668](../../docs/plans/continuo_design.md#L8668)）。
...
（[docs/plans/continuo_design.md:8660-8672](../../docs/plans/continuo_design.md#L8660-L8672)）。
...
（[docs/plans/continuo_design.md:8663](../../docs/plans/continuo_design.md#L8663) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8706](../../docs/plans/continuo_design.md#L8706) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8708](../../docs/plans/continuo_design.md#L8708)）。104件の全並べ替えで約2分かかる |
...
| **グループごとの計画** | **そのグループの代表の issue のコメントへ残す**（[docs/plans/continuo_design.md:3485](../../docs/plans/continuo_design.md#L3485) の 3-26） |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8664](../../docs/plans/continuo_design.md#L8664) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
[docs/plans/continuo_design.md:3508-3509](../../docs/plans/continuo_design.md#L3508-L3509) の 3-26 が
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8708](../../docs/plans/continuo_design.md#L8708)）。
