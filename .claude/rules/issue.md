...
（載せることと Status は [docs/plans/continuo_design.md:8608](../../docs/plans/continuo_design.md#L8608)、
並べ替えは [docs/plans/continuo_design.md:8795-8799](../../docs/plans/continuo_design.md#L8795-L8799) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8614](../../docs/plans/continuo_design.md#L8614)）。
...
（[docs/plans/continuo_design.md:8606-8618](../../docs/plans/continuo_design.md#L8606-L8618)）。
...
（[docs/plans/continuo_design.md:8609](../../docs/plans/continuo_design.md#L8609) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8652](../../docs/plans/continuo_design.md#L8652) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8654](../../docs/plans/continuo_design.md#L8654)）。104件の全並べ替えで約2分かかる |
...
| **グループごとの計画** | **そのグループの代表の issue のコメントへ残す**（[docs/plans/continuo_design.md:3396](../../docs/plans/continuo_design.md#L3396) の 3-26） |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8610](../../docs/plans/continuo_design.md#L8610) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
[docs/plans/continuo_design.md:3419-3420](../../docs/plans/continuo_design.md#L3419-L3420) の 3-26 が
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8654](../../docs/plans/continuo_design.md#L8654)）。
