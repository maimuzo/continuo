...
（載せることと Status は [docs/plans/continuo_design.md:9049](../../docs/plans/continuo_design.md#L9049)、
並べ替えは [docs/plans/continuo_design.md:9236-9240](../../docs/plans/continuo_design.md#L9236-L9240) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9055](../../docs/plans/continuo_design.md#L9055)）。
...
（[docs/plans/continuo_design.md:9047-9059](../../docs/plans/continuo_design.md#L9047-L9059)）。
...
（[docs/plans/continuo_design.md:9050](../../docs/plans/continuo_design.md#L9050) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9093](../../docs/plans/continuo_design.md#L9093) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9095](../../docs/plans/continuo_design.md#L9095)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9051](../../docs/plans/continuo_design.md#L9051) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9095](../../docs/plans/continuo_design.md#L9095)）。
