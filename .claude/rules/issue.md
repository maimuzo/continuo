...
（載せることと Status は [docs/plans/continuo_design.md:9779](../../docs/plans/continuo_design.md#L9779)、
並べ替えは [docs/plans/continuo_design.md:9966-9970](../../docs/plans/continuo_design.md#L9966-L9970) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9785](../../docs/plans/continuo_design.md#L9785)）。
...
（[docs/plans/continuo_design.md:9777-9789](../../docs/plans/continuo_design.md#L9777-L9789)）。
...
（[docs/plans/continuo_design.md:9780](../../docs/plans/continuo_design.md#L9780) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9823](../../docs/plans/continuo_design.md#L9823) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9825](../../docs/plans/continuo_design.md#L9825)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9781](../../docs/plans/continuo_design.md#L9781) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9825](../../docs/plans/continuo_design.md#L9825)）。
