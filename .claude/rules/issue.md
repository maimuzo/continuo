...
（載せることと Status は [docs/plans/continuo_design.md:9747](../../docs/plans/continuo_design.md#L9747)、
並べ替えは [docs/plans/continuo_design.md:9934-9938](../../docs/plans/continuo_design.md#L9934-L9938) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9753](../../docs/plans/continuo_design.md#L9753)）。
...
（[docs/plans/continuo_design.md:9745-9757](../../docs/plans/continuo_design.md#L9745-L9757)）。
...
（[docs/plans/continuo_design.md:9748](../../docs/plans/continuo_design.md#L9748) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9791](../../docs/plans/continuo_design.md#L9791) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9793](../../docs/plans/continuo_design.md#L9793)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9749](../../docs/plans/continuo_design.md#L9749) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9793](../../docs/plans/continuo_design.md#L9793)）。
