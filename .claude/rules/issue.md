...
（[internal/prompt/builtin.md:432](../../internal/prompt/builtin.md#L432) は「あなたが `gh` を叩く必要はありません」）。
...
組み込みの指示書（[internal/prompt/builtin.md:1145-1167](../../internal/prompt/builtin.md#L1145-L1167) の 7-2）が、
