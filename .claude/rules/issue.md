...
（載せることと Status は [docs/plans/continuo_design.md:9419](../../docs/plans/continuo_design.md#L9419)、
並べ替えは [docs/plans/continuo_design.md:9606-9610](../../docs/plans/continuo_design.md#L9606-L9610) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9425](../../docs/plans/continuo_design.md#L9425)）。
...
（[docs/plans/continuo_design.md:9417-9429](../../docs/plans/continuo_design.md#L9417-L9429)）。
...
（[docs/plans/continuo_design.md:9420](../../docs/plans/continuo_design.md#L9420) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9463](../../docs/plans/continuo_design.md#L9463) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9465](../../docs/plans/continuo_design.md#L9465)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9421](../../docs/plans/continuo_design.md#L9421) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9465](../../docs/plans/continuo_design.md#L9465)）。
