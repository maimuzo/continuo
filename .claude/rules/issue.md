...
（載せることと Status は [docs/plans/continuo_design.md:8572](../../docs/plans/continuo_design.md#L8572)、
並べ替えは [docs/plans/continuo_design.md:8759-8763](../../docs/plans/continuo_design.md#L8759-L8763) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8578](../../docs/plans/continuo_design.md#L8578)）。
...
（[docs/plans/continuo_design.md:8570-8582](../../docs/plans/continuo_design.md#L8570-L8582)）。
...
（[docs/plans/continuo_design.md:8573](../../docs/plans/continuo_design.md#L8573) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8616](../../docs/plans/continuo_design.md#L8616) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8618](../../docs/plans/continuo_design.md#L8618)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8574](../../docs/plans/continuo_design.md#L8574) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8618](../../docs/plans/continuo_design.md#L8618)）。
