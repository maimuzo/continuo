...
（載せることと Status は [docs/plans/continuo_design.md:8924](../../docs/plans/continuo_design.md#L8924)、
並べ替えは [docs/plans/continuo_design.md:9111-9115](../../docs/plans/continuo_design.md#L9111-L9115) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8930](../../docs/plans/continuo_design.md#L8930)）。
...
（[docs/plans/continuo_design.md:8922-8934](../../docs/plans/continuo_design.md#L8922-L8934)）。
...
（[docs/plans/continuo_design.md:8925](../../docs/plans/continuo_design.md#L8925) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8968](../../docs/plans/continuo_design.md#L8968) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8970](../../docs/plans/continuo_design.md#L8970)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8926](../../docs/plans/continuo_design.md#L8926) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8970](../../docs/plans/continuo_design.md#L8970)）。
