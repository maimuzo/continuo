...
（載せることと Status は [docs/plans/continuo_design.md:9950](../../docs/plans/continuo_design.md#L9950)、
...
（[docs/plans/continuo_design.md:9956](../../docs/plans/continuo_design.md#L9956)）。
...
（[docs/plans/continuo_design.md:9948-9960](../../docs/plans/continuo_design.md#L9948-L9960)）。
...
（[docs/plans/continuo_design.md:9951](../../docs/plans/continuo_design.md#L9951) の 4-1 の遷移表）。
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9952](../../docs/plans/continuo_design.md#L9952) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
