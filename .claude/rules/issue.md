...
（載せることと Status は [docs/plans/continuo_design.md:9633](../../docs/plans/continuo_design.md#L9633)、
並べ替えは [docs/plans/continuo_design.md:9820-9824](../../docs/plans/continuo_design.md#L9820-L9824) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9639](../../docs/plans/continuo_design.md#L9639)）。
...
（[docs/plans/continuo_design.md:9631-9643](../../docs/plans/continuo_design.md#L9631-L9643)）。
...
（[docs/plans/continuo_design.md:9634](../../docs/plans/continuo_design.md#L9634) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9677](../../docs/plans/continuo_design.md#L9677) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9679](../../docs/plans/continuo_design.md#L9679)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9635](../../docs/plans/continuo_design.md#L9635) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9679](../../docs/plans/continuo_design.md#L9679)）。
