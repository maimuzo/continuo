...
（[internal/prompt/builtin.md:339](../../internal/prompt/builtin.md#L339) は「あなたが `gh` を叩く必要はありません」）。
...
組み込みの指示書（[internal/prompt/builtin.md:738-684](../../internal/prompt/builtin.md#L738-L741) の 7-2）が、
