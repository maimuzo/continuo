...
（[internal/prompt/builtin.md:412](../../internal/prompt/builtin.md#L412) は「あなたが `gh` を叩く必要はありません」）。
...
組み込みの指示書（[internal/prompt/builtin.md:1063-1085](../../internal/prompt/builtin.md#L1063-L1085) の 7-2）が、
