...
（載せることと Status は [docs/plans/continuo_design.md:8673](../../docs/plans/continuo_design.md#L8673)、
並べ替えは [docs/plans/continuo_design.md:8860-8864](../../docs/plans/continuo_design.md#L8860-L8864) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8679](../../docs/plans/continuo_design.md#L8679)）。
...
（[docs/plans/continuo_design.md:8671-8683](../../docs/plans/continuo_design.md#L8671-L8683)）。
...
（[docs/plans/continuo_design.md:8674](../../docs/plans/continuo_design.md#L8674) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8717](../../docs/plans/continuo_design.md#L8717) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8719](../../docs/plans/continuo_design.md#L8719)）。104件の全並べ替えで約2分かかる |
...
| **グループごとの計画** | **そのグループの代表の issue のコメントへ残す**（[docs/plans/continuo_design.md:3496](../../docs/plans/continuo_design.md#L3496) の 3-26） |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8675](../../docs/plans/continuo_design.md#L8675) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
[docs/plans/continuo_design.md:3519-3520](../../docs/plans/continuo_design.md#L3519-L3520) の 3-26 が
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8719](../../docs/plans/continuo_design.md#L8719)）。
