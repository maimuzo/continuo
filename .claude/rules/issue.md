...
（載せることと Status は [docs/plans/continuo_design.md:10097](../../docs/plans/continuo_design.md#L10097)、
並べ替えは [docs/plans/continuo_design.md:10284-10288](../../docs/plans/continuo_design.md#L10284-L10288) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:10103](../../docs/plans/continuo_design.md#L10103)）。
...
（[docs/plans/continuo_design.md:10095-10107](../../docs/plans/continuo_design.md#L10095-L10107)）。
...
（[docs/plans/continuo_design.md:10098](../../docs/plans/continuo_design.md#L10098) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:10141](../../docs/plans/continuo_design.md#L10141) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:10143](../../docs/plans/continuo_design.md#L10143)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:10099](../../docs/plans/continuo_design.md#L10099) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:10143](../../docs/plans/continuo_design.md#L10143)）。
