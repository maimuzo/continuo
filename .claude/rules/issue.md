...
（載せることと Status は [docs/plans/continuo_design.md:8777](../../docs/plans/continuo_design.md#L8777)、
並べ替えは [docs/plans/continuo_design.md:8962-8969](../../docs/plans/continuo_design.md#L8962-L8969) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8783](../../docs/plans/continuo_design.md#L8783)）。
...
（[docs/plans/continuo_design.md:8775-8787](../../docs/plans/continuo_design.md#L8775-L8787)）。
...
（[docs/plans/continuo_design.md:8778](../../docs/plans/continuo_design.md#L8778) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8821](../../docs/plans/continuo_design.md#L8821) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:3985](../../docs/plans/continuo_design.md#L3985)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8779](../../docs/plans/continuo_design.md#L8779) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:3985](../../docs/plans/continuo_design.md#L3985)）。
