...
（載せることと Status は [docs/plans/continuo_design.md:9198](../../docs/plans/continuo_design.md#L9198)、
並べ替えは [docs/plans/continuo_design.md:9385-9389](../../docs/plans/continuo_design.md#L9385-L9389) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9204](../../docs/plans/continuo_design.md#L9204)）。
...
（[docs/plans/continuo_design.md:9196-9208](../../docs/plans/continuo_design.md#L9196-L9208)）。
...
（[docs/plans/continuo_design.md:9199](../../docs/plans/continuo_design.md#L9199) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9242](../../docs/plans/continuo_design.md#L9242) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9244](../../docs/plans/continuo_design.md#L9244)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9200](../../docs/plans/continuo_design.md#L9200) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9244](../../docs/plans/continuo_design.md#L9244)）。
...
組み込みの指示書（[internal/prompt/builtin.md:696-860](../../internal/prompt/builtin.md#L696-L860) の 7-2）が、
