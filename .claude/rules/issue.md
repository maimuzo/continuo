...
（載せることと Status は [docs/plans/continuo_design.md:9775](../../docs/plans/continuo_design.md#L9775)、
並べ替えは [docs/plans/continuo_design.md:9962-9966](../../docs/plans/continuo_design.md#L9962-L9966) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9781](../../docs/plans/continuo_design.md#L9781)）。
...
（[docs/plans/continuo_design.md:9773-9785](../../docs/plans/continuo_design.md#L9773-L9785)）。
...
（[docs/plans/continuo_design.md:9776](../../docs/plans/continuo_design.md#L9776) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9819](../../docs/plans/continuo_design.md#L9819) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9821](../../docs/plans/continuo_design.md#L9821)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9777](../../docs/plans/continuo_design.md#L9777) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9821](../../docs/plans/continuo_design.md#L9821)）。
