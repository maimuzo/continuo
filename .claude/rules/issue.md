...
（載せることと Status は [docs/plans/continuo_design.md:10051](../../docs/plans/continuo_design.md#L10051)、
並べ替えは [docs/plans/continuo_design.md:10237-10245](../../docs/plans/continuo_design.md#L10237-L10245) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:10056](../../docs/plans/continuo_design.md#L10056)）。
...
（[docs/plans/continuo_design.md:10048-10060](../../docs/plans/continuo_design.md#L10048-L10060)）。
...
（[docs/plans/continuo_design.md:10051](../../docs/plans/continuo_design.md#L10051) の 4-1 の遷移表）。
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:10057](../../docs/plans/continuo_design.md#L10057) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
