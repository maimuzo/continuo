...
（載せることと Status は [docs/plans/continuo_design.md:9317](../../docs/plans/continuo_design.md#L9317)、
並べ替えは [docs/plans/continuo_design.md:9504-9508](../../docs/plans/continuo_design.md#L9504-L9508) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9323](../../docs/plans/continuo_design.md#L9323)）。
...
（[docs/plans/continuo_design.md:9315-9327](../../docs/plans/continuo_design.md#L9315-L9327)）。
...
（[docs/plans/continuo_design.md:9318](../../docs/plans/continuo_design.md#L9318) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9361](../../docs/plans/continuo_design.md#L9361) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9363](../../docs/plans/continuo_design.md#L9363)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9319](../../docs/plans/continuo_design.md#L9319) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9363](../../docs/plans/continuo_design.md#L9363)）。
