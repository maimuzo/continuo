...
（載せることと Status は [docs/plans/continuo_design.md:9445](../../docs/plans/continuo_design.md#L9445)、
並べ替えは [docs/plans/continuo_design.md:9632-9636](../../docs/plans/continuo_design.md#L9632-L9636) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9451](../../docs/plans/continuo_design.md#L9451)）。
...
（[docs/plans/continuo_design.md:9443-9455](../../docs/plans/continuo_design.md#L9443-L9455)）。
...
（[docs/plans/continuo_design.md:9446](../../docs/plans/continuo_design.md#L9446) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9489](../../docs/plans/continuo_design.md#L9489) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:4332](../../docs/plans/continuo_design.md#L4332)）。104件の全並べ替えで約2分かかる |
...
| **グループごとの計画** | **そのグループの代表の issue のコメントへ残す**（[docs/plans/continuo_design.md:3608](../../docs/plans/continuo_design.md#L3608) の 3-26） |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9447](../../docs/plans/continuo_design.md#L9447) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:4332](../../docs/plans/continuo_design.md#L4332)）。
