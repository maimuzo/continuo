...
（載せることと Status は [docs/plans/continuo_design.md:9297](../../docs/plans/continuo_design.md#L9297)、
並べ替えは [docs/plans/continuo_design.md:9484-9488](../../docs/plans/continuo_design.md#L9484-L9488) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9303](../../docs/plans/continuo_design.md#L9303)）。
...
（[docs/plans/continuo_design.md:9295-9307](../../docs/plans/continuo_design.md#L9295-L9307)）。
...
（[docs/plans/continuo_design.md:9298](../../docs/plans/continuo_design.md#L9298) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9341](../../docs/plans/continuo_design.md#L9341) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9343](../../docs/plans/continuo_design.md#L9343)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9299](../../docs/plans/continuo_design.md#L9299) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9343](../../docs/plans/continuo_design.md#L9343)）。
...
組み込みの指示書（[internal/prompt/builtin.md:761-776](../../internal/prompt/builtin.md#L761-L776) の 7-2）が、
