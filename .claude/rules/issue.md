...
（載せることと Status は [docs/plans/continuo_design.md:8580](../../docs/plans/continuo_design.md#L8580)、
並べ替えは [docs/plans/continuo_design.md:8767-8771](../../docs/plans/continuo_design.md#L8767-L8771) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8586](../../docs/plans/continuo_design.md#L8586)）。
...
（[docs/plans/continuo_design.md:8578-8590](../../docs/plans/continuo_design.md#L8578-L8590)）。
...
（[docs/plans/continuo_design.md:8581](../../docs/plans/continuo_design.md#L8581) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8624](../../docs/plans/continuo_design.md#L8624) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8626](../../docs/plans/continuo_design.md#L8626)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8582](../../docs/plans/continuo_design.md#L8582) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8626](../../docs/plans/continuo_design.md#L8626)）。
