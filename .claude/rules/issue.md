...
（載せることと Status は [docs/plans/continuo_design.md:9168](../../docs/plans/continuo_design.md#L9168)、
並べ替えは [docs/plans/continuo_design.md:9357-9361](../../docs/plans/continuo_design.md#L9357-L9361) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9174](../../docs/plans/continuo_design.md#L9174)）。
...
（[docs/plans/continuo_design.md:9166-9178](../../docs/plans/continuo_design.md#L9166-L9178)）。
...
（[docs/plans/continuo_design.md:9169](../../docs/plans/continuo_design.md#L9169) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9214](../../docs/plans/continuo_design.md#L9214) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9216](../../docs/plans/continuo_design.md#L9216)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9170](../../docs/plans/continuo_design.md#L9170) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9216](../../docs/plans/continuo_design.md#L9216)）。
