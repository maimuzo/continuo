...
（載せることと Status は [docs/plans/continuo_design.md:9658](../../docs/plans/continuo_design.md#L9658)、
並べ替えは [docs/plans/continuo_design.md:9845-9849](../../docs/plans/continuo_design.md#L9845-L9849) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9664](../../docs/plans/continuo_design.md#L9664)）。
...
（[docs/plans/continuo_design.md:9656-9668](../../docs/plans/continuo_design.md#L9656-L9668)）。
...
（[docs/plans/continuo_design.md:9659](../../docs/plans/continuo_design.md#L9659) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9702](../../docs/plans/continuo_design.md#L9702) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9704](../../docs/plans/continuo_design.md#L9704)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9660](../../docs/plans/continuo_design.md#L9660) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9704](../../docs/plans/continuo_design.md#L9704)）。
