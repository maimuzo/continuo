...
（載せることと Status は [docs/plans/continuo_design.md:9956](../../docs/plans/continuo_design.md#L9956)、
並べ替えは [docs/plans/continuo_design.md:10143-10147](../../docs/plans/continuo_design.md#L10143-L10147) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9962](../../docs/plans/continuo_design.md#L9962)）。
...
（[docs/plans/continuo_design.md:9954-9966](../../docs/plans/continuo_design.md#L9954-L9966)）。
...
（[docs/plans/continuo_design.md:9957](../../docs/plans/continuo_design.md#L9957) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:10000](../../docs/plans/continuo_design.md#L10000) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:10002](../../docs/plans/continuo_design.md#L10002)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9958](../../docs/plans/continuo_design.md#L9958) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:10002](../../docs/plans/continuo_design.md#L10002)）。
