...
（載せることと Status は [docs/plans/continuo_design.md:8545](../../docs/plans/continuo_design.md#L8545)、
並べ替えは [docs/plans/continuo_design.md:8732-8736](../../docs/plans/continuo_design.md#L8732-L8736) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8551](../../docs/plans/continuo_design.md#L8551)）。
...
（[docs/plans/continuo_design.md:8543-8555](../../docs/plans/continuo_design.md#L8543-L8555)）。
...
（[docs/plans/continuo_design.md:8546](../../docs/plans/continuo_design.md#L8546) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8589](../../docs/plans/continuo_design.md#L8589) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8591](../../docs/plans/continuo_design.md#L8591)）。104件の全並べ替えで約2分かかる |
...
| **グループごとの計画** | **そのグループの代表の issue のコメントへ残す**（[docs/plans/continuo_design.md:3368](../../docs/plans/continuo_design.md#L3368) の 3-26） |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8547](../../docs/plans/continuo_design.md#L8547) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
[docs/plans/continuo_design.md:3391-3392](../../docs/plans/continuo_design.md#L3391-L3392) の 3-26 が
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8591](../../docs/plans/continuo_design.md#L8591)）。
