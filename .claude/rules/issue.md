...
（載せることと Status は [docs/plans/continuo_design.md:8621](../../docs/plans/continuo_design.md#L8621)、
並べ替えは [docs/plans/continuo_design.md:8808-8812](../../docs/plans/continuo_design.md#L8808-L8812) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8627](../../docs/plans/continuo_design.md#L8627)）。
...
（[docs/plans/continuo_design.md:8619-8631](../../docs/plans/continuo_design.md#L8619-L8631)）。
...
（[docs/plans/continuo_design.md:8622](../../docs/plans/continuo_design.md#L8622) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8665](../../docs/plans/continuo_design.md#L8665) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8667](../../docs/plans/continuo_design.md#L8667)）。104件の全並べ替えで約2分かかる |
...
| **グループごとの計画** | **そのグループの代表の issue のコメントへ残す**（[docs/plans/continuo_design.md:3444](../../docs/plans/continuo_design.md#L3444) の 3-26） |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8623](../../docs/plans/continuo_design.md#L8623) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
[docs/plans/continuo_design.md:3467-3468](../../docs/plans/continuo_design.md#L3467-L3468) の 3-26 が
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8667](../../docs/plans/continuo_design.md#L8667)）。
