...
（載せることと Status は [docs/plans/continuo_design.md:8866](../../docs/plans/continuo_design.md#L8866)、
並べ替えは [docs/plans/continuo_design.md:9053-9057](../../docs/plans/continuo_design.md#L9053-L9057) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8872](../../docs/plans/continuo_design.md#L8872)）。
...
（[docs/plans/continuo_design.md:8864-8876](../../docs/plans/continuo_design.md#L8864-L8876)）。
...
（[docs/plans/continuo_design.md:8867](../../docs/plans/continuo_design.md#L8867) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8910](../../docs/plans/continuo_design.md#L8910) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8912](../../docs/plans/continuo_design.md#L8912)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8868](../../docs/plans/continuo_design.md#L8868) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8912](../../docs/plans/continuo_design.md#L8912)）。
