...
（載せることと Status は [docs/plans/continuo_design.md:8634](../../docs/plans/continuo_design.md#L8634)、
並べ替えは [docs/plans/continuo_design.md:8821-8825](../../docs/plans/continuo_design.md#L8821-L8825) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8640](../../docs/plans/continuo_design.md#L8640)）。
...
（[docs/plans/continuo_design.md:8632-8644](../../docs/plans/continuo_design.md#L8632-L8644)）。
...
（[docs/plans/continuo_design.md:8635](../../docs/plans/continuo_design.md#L8635) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8678](../../docs/plans/continuo_design.md#L8678) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8680](../../docs/plans/continuo_design.md#L8680)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8636](../../docs/plans/continuo_design.md#L8636) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8680](../../docs/plans/continuo_design.md#L8680)）。
