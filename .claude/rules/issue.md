...
（載せることと Status は [docs/plans/continuo_design.md:9139](../../docs/plans/continuo_design.md#L9139)、
並べ替えは [docs/plans/continuo_design.md:9326-9330](../../docs/plans/continuo_design.md#L9326-L9330) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9145](../../docs/plans/continuo_design.md#L9145)）。
...
（[docs/plans/continuo_design.md:9137-9149](../../docs/plans/continuo_design.md#L9137-L9149)）。
...
（[docs/plans/continuo_design.md:9140](../../docs/plans/continuo_design.md#L9140) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9183](../../docs/plans/continuo_design.md#L9183) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9185](../../docs/plans/continuo_design.md#L9185)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9141](../../docs/plans/continuo_design.md#L9141) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9185](../../docs/plans/continuo_design.md#L9185)）。
