...
（[internal/prompt/builtin.md:421](../../internal/prompt/builtin.md#L421) は「あなたが `gh` を叩く必要はありません」）。
...
組み込みの指示書（[internal/prompt/builtin.md:1089-1111](../../internal/prompt/builtin.md#L1089-L1111) の 7-2）が、
