...
（載せることと Status は [docs/plans/continuo_design.md:8844](../../docs/plans/continuo_design.md#L8844)、
並べ替えは [docs/plans/continuo_design.md:9031-9035](../../docs/plans/continuo_design.md#L9031-L9035) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8850](../../docs/plans/continuo_design.md#L8850)）。
...
（[docs/plans/continuo_design.md:8842-8854](../../docs/plans/continuo_design.md#L8842-L8854)）。
...
（[docs/plans/continuo_design.md:8845](../../docs/plans/continuo_design.md#L8845) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8888](../../docs/plans/continuo_design.md#L8888) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8890](../../docs/plans/continuo_design.md#L8890)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8846](../../docs/plans/continuo_design.md#L8846) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8890](../../docs/plans/continuo_design.md#L8890)）。
