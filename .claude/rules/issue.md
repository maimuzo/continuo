...
（[internal/prompt/builtin.md:318](../../internal/prompt/builtin.md#L318) は「あなたが `gh` を叩く必要はありません」）。
...
組み込みの指示書（[internal/prompt/builtin.md:718-721](../../internal/prompt/builtin.md#L718-L721) の 7-2）が、
