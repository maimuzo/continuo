...
（載せることと Status は [docs/plans/continuo_design.md:10222](../../docs/plans/continuo_design.md#L10222)、
並べ替えは [docs/plans/continuo_design.md:10404-10270](../../docs/plans/continuo_design.md#L10404-L10270) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:10231](../../docs/plans/continuo_design.md#L10231)）。
...
（[docs/plans/continuo_design.md:10226-10060](../../docs/plans/continuo_design.md#L10226-L10060)）。
...
（[docs/plans/continuo_design.md:10222](../../docs/plans/continuo_design.md#L10222) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:10270](../../docs/plans/continuo_design.md#L10270) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:10272](../../docs/plans/continuo_design.md#L10272)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:10228](../../docs/plans/continuo_design.md#L10228) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:10272](../../docs/plans/continuo_design.md#L10272)）。
