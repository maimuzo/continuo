...
（載せることと Status は [docs/plans/continuo_design.md:8615](../../docs/plans/continuo_design.md#L8615)、
並べ替えは [docs/plans/continuo_design.md:8802-8806](../../docs/plans/continuo_design.md#L8802-L8806) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8621](../../docs/plans/continuo_design.md#L8621)）。
...
（[docs/plans/continuo_design.md:8613-8625](../../docs/plans/continuo_design.md#L8613-L8625)）。
...
（[docs/plans/continuo_design.md:8616](../../docs/plans/continuo_design.md#L8616) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8659](../../docs/plans/continuo_design.md#L8659) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8661](../../docs/plans/continuo_design.md#L8661)）。104件の全並べ替えで約2分かかる |
...
| **グループごとの計画** | **そのグループの代表の issue のコメントへ残す**（[docs/plans/continuo_design.md:3401](../../docs/plans/continuo_design.md#L3401) の 3-26） |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8617](../../docs/plans/continuo_design.md#L8617) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
[docs/plans/continuo_design.md:3424-3425](../../docs/plans/continuo_design.md#L3424-L3425) の 3-26 が
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8661](../../docs/plans/continuo_design.md#L8661)）。
