...
（載せることと Status は [docs/plans/continuo_design.md:9859](../../docs/plans/continuo_design.md#L9859)、
並べ替えは [docs/plans/continuo_design.md:10046-10050](../../docs/plans/continuo_design.md#L10046-L10050) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9865](../../docs/plans/continuo_design.md#L9865)）。
...
（[docs/plans/continuo_design.md:9857-9869](../../docs/plans/continuo_design.md#L9857-L9869)）。
...
（[docs/plans/continuo_design.md:9860](../../docs/plans/continuo_design.md#L9860) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9903](../../docs/plans/continuo_design.md#L9903) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9905](../../docs/plans/continuo_design.md#L9905)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9861](../../docs/plans/continuo_design.md#L9861) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9905](../../docs/plans/continuo_design.md#L9905)）。
