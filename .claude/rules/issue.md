...
（載せることと Status は [docs/plans/continuo_design.md:10550](../../docs/plans/continuo_design.md#L10550)、
並べ替えは [docs/plans/continuo_design.md:10732-10598](../../docs/plans/continuo_design.md#L10732-L10598) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:10559](../../docs/plans/continuo_design.md#L10559)）。
...
（[docs/plans/continuo_design.md:10554-10060](../../docs/plans/continuo_design.md#L10554-L10060)）。
...
（[docs/plans/continuo_design.md:10550](../../docs/plans/continuo_design.md#L10550) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:10598](../../docs/plans/continuo_design.md#L10598) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:10600](../../docs/plans/continuo_design.md#L10600)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:10556](../../docs/plans/continuo_design.md#L10556) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:10600](../../docs/plans/continuo_design.md#L10600)）。
