...
（[docs/plans/continuo_design.md:9440](../../docs/plans/continuo_design.md#L9440)）。
...
（[docs/plans/continuo_design.md:9432-9440](../../docs/plans/continuo_design.md#L9432-L9440)）。
...
（[docs/plans/continuo_design.md:9435](../../docs/plans/continuo_design.md#L9435) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9478](../../docs/plans/continuo_design.md#L9478) の 4-2）。
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9436](../../docs/plans/continuo_design.md#L9436) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
