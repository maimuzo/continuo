...
（載せることと Status は [docs/plans/continuo_design.md:8828](../../docs/plans/continuo_design.md#L8828)、
並べ替えは [docs/plans/continuo_design.md:9015-9019](../../docs/plans/continuo_design.md#L9015-L9019) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8834](../../docs/plans/continuo_design.md#L8834)）。
...
（[docs/plans/continuo_design.md:8826-8838](../../docs/plans/continuo_design.md#L8826-L8838)）。
...
（[docs/plans/continuo_design.md:8829](../../docs/plans/continuo_design.md#L8829) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8872](../../docs/plans/continuo_design.md#L8872) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8874](../../docs/plans/continuo_design.md#L8874)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8830](../../docs/plans/continuo_design.md#L8830) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8874](../../docs/plans/continuo_design.md#L8874)）。
