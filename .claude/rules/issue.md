...
（載せることと Status は [docs/plans/continuo_design.md:9843](../../docs/plans/continuo_design.md#L9843)、
並べ替えは [docs/plans/continuo_design.md:10030-10034](../../docs/plans/continuo_design.md#L10030-L10034) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9849](../../docs/plans/continuo_design.md#L9849)）。
...
（[docs/plans/continuo_design.md:9841-9853](../../docs/plans/continuo_design.md#L9841-L9853)）。
...
（[docs/plans/continuo_design.md:9844](../../docs/plans/continuo_design.md#L9844) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9887](../../docs/plans/continuo_design.md#L9887) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9889](../../docs/plans/continuo_design.md#L9889)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9845](../../docs/plans/continuo_design.md#L9845) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9889](../../docs/plans/continuo_design.md#L9889)）。
