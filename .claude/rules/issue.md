...
（載せることと Status は [docs/plans/continuo_design.md:9414](../../docs/plans/continuo_design.md#L9414)、
並べ替えは [docs/plans/continuo_design.md:9601-9605](../../docs/plans/continuo_design.md#L9601-L9605) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9420](../../docs/plans/continuo_design.md#L9420)）。
...
（[docs/plans/continuo_design.md:9412-9424](../../docs/plans/continuo_design.md#L9412-L9424)）。
...
（[docs/plans/continuo_design.md:9415](../../docs/plans/continuo_design.md#L9415) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9458](../../docs/plans/continuo_design.md#L9458) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:4302](../../docs/plans/continuo_design.md#L4302)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9416](../../docs/plans/continuo_design.md#L9416) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:4302](../../docs/plans/continuo_design.md#L4302)）。
