...
（載せることと Status は [docs/plans/continuo_design.md:9409](../../docs/plans/continuo_design.md#L9409)、
並べ替えは [docs/plans/continuo_design.md:9596-9600](../../docs/plans/continuo_design.md#L9596-L9600) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9415](../../docs/plans/continuo_design.md#L9415)）。
...
（[docs/plans/continuo_design.md:9407-9419](../../docs/plans/continuo_design.md#L9407-L9419)）。
...
（[docs/plans/continuo_design.md:9410](../../docs/plans/continuo_design.md#L9410) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9453](../../docs/plans/continuo_design.md#L9453) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9455](../../docs/plans/continuo_design.md#L9455)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9411](../../docs/plans/continuo_design.md#L9411) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9455](../../docs/plans/continuo_design.md#L9455)）。
