...
（載せることと Status は [docs/plans/continuo_design.md:9749](../../docs/plans/continuo_design.md#L9749)、
並べ替えは [docs/plans/continuo_design.md:9939-9943](../../docs/plans/continuo_design.md#L9939-L9943) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9755](../../docs/plans/continuo_design.md#L9755)）。
...
（[docs/plans/continuo_design.md:9747-9759](../../docs/plans/continuo_design.md#L9747-L9759)）。
...
（[docs/plans/continuo_design.md:9750](../../docs/plans/continuo_design.md#L9750) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9796](../../docs/plans/continuo_design.md#L9796) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9798](../../docs/plans/continuo_design.md#L9798)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9751](../../docs/plans/continuo_design.md#L9751) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9798](../../docs/plans/continuo_design.md#L9798)）。
