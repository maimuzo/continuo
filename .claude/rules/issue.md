...
（載せることと Status は [docs/plans/continuo_design.md:10154](../../docs/plans/continuo_design.md#L10154)、
並べ替えは [docs/plans/continuo_design.md:10341-10345](../../docs/plans/continuo_design.md#L10341-L10345) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:10160](../../docs/plans/continuo_design.md#L10160)）。
...
（[docs/plans/continuo_design.md:10152-10164](../../docs/plans/continuo_design.md#L10152-L10164)）。
...
（[docs/plans/continuo_design.md:10155](../../docs/plans/continuo_design.md#L10155) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:10198](../../docs/plans/continuo_design.md#L10198) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:10200](../../docs/plans/continuo_design.md#L10200)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:10156](../../docs/plans/continuo_design.md#L10156) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:10200](../../docs/plans/continuo_design.md#L10200)）。
