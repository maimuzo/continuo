...
（載せることと Status は [docs/plans/continuo_design.md:9151](../../docs/plans/continuo_design.md#L9151)、
並べ替えは [docs/plans/continuo_design.md:9338-9342](../../docs/plans/continuo_design.md#L9338-L9342) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9157](../../docs/plans/continuo_design.md#L9157)）。
...
（[docs/plans/continuo_design.md:9149-9161](../../docs/plans/continuo_design.md#L9149-L9161)）。
...
（[docs/plans/continuo_design.md:9152](../../docs/plans/continuo_design.md#L9152) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9195](../../docs/plans/continuo_design.md#L9195) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9197](../../docs/plans/continuo_design.md#L9197)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9153](../../docs/plans/continuo_design.md#L9153) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9197](../../docs/plans/continuo_design.md#L9197)）。
