...
（載せることと Status は [docs/plans/continuo_design.md:9649](../../docs/plans/continuo_design.md#L9649)、
並べ替えは [docs/plans/continuo_design.md:9836-9840](../../docs/plans/continuo_design.md#L9836-L9840) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9655](../../docs/plans/continuo_design.md#L9655)）。
...
（[docs/plans/continuo_design.md:9647-9659](../../docs/plans/continuo_design.md#L9647-L9659)）。
...
（[docs/plans/continuo_design.md:9650](../../docs/plans/continuo_design.md#L9650) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9693](../../docs/plans/continuo_design.md#L9693) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9695](../../docs/plans/continuo_design.md#L9695)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9651](../../docs/plans/continuo_design.md#L9651) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9695](../../docs/plans/continuo_design.md#L9695)）。
