...
（載せることと Status は [docs/plans/continuo_design.md:9572](../../docs/plans/continuo_design.md#L9572)、
並べ替えは [docs/plans/continuo_design.md:9759-9763](../../docs/plans/continuo_design.md#L9759-L9763) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9578](../../docs/plans/continuo_design.md#L9578)）。
...
（[docs/plans/continuo_design.md:9570-9582](../../docs/plans/continuo_design.md#L9570-L9582)）。
...
（[docs/plans/continuo_design.md:9573](../../docs/plans/continuo_design.md#L9573) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9616](../../docs/plans/continuo_design.md#L9616) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9618](../../docs/plans/continuo_design.md#L9618)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9574](../../docs/plans/continuo_design.md#L9574) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9618](../../docs/plans/continuo_design.md#L9618)）。
