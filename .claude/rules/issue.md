...
（載せることと Status は [docs/plans/continuo_design.md:9922](../../docs/plans/continuo_design.md#L9922)、
...
（[docs/plans/continuo_design.md:9928](../../docs/plans/continuo_design.md#L9928)）。
...
（[docs/plans/continuo_design.md:9920-9932](../../docs/plans/continuo_design.md#L9920-L9932)）。
...
（[docs/plans/continuo_design.md:9923](../../docs/plans/continuo_design.md#L9923) の 4-1 の遷移表）。
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9924](../../docs/plans/continuo_design.md#L9924) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
