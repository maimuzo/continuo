...
（載せることと Status は [docs/plans/continuo_design.md:8600](../../docs/plans/continuo_design.md#L8600)、
並べ替えは [docs/plans/continuo_design.md:8787-8791](../../docs/plans/continuo_design.md#L8787-L8791) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8606](../../docs/plans/continuo_design.md#L8606)）。
...
（[docs/plans/continuo_design.md:8598-8610](../../docs/plans/continuo_design.md#L8598-L8610)）。
...
（[docs/plans/continuo_design.md:8601](../../docs/plans/continuo_design.md#L8601) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8644](../../docs/plans/continuo_design.md#L8644) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8646](../../docs/plans/continuo_design.md#L8646)）。104件の全並べ替えで約2分かかる |
...
| **グループごとの計画** | **そのグループの代表の issue のコメントへ残す**（[docs/plans/continuo_design.md:3388](../../docs/plans/continuo_design.md#L3388) の 3-26） |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8602](../../docs/plans/continuo_design.md#L8602) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
[docs/plans/continuo_design.md:3411-3412](../../docs/plans/continuo_design.md#L3411-L3412) の 3-26 が
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8646](../../docs/plans/continuo_design.md#L8646)）。
