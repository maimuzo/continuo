...
（載せることと Status は [docs/plans/continuo_design.md:9471](../../docs/plans/continuo_design.md#L9471)、
並べ替えは [docs/plans/continuo_design.md:9658-9662](../../docs/plans/continuo_design.md#L9658-L9662) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9477](../../docs/plans/continuo_design.md#L9477)）。
...
（[docs/plans/continuo_design.md:9469-9481](../../docs/plans/continuo_design.md#L9469-L9481)）。
...
（[docs/plans/continuo_design.md:9472](../../docs/plans/continuo_design.md#L9472) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9515](../../docs/plans/continuo_design.md#L9515) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9517](../../docs/plans/continuo_design.md#L9517)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9473](../../docs/plans/continuo_design.md#L9473) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9517](../../docs/plans/continuo_design.md#L9517)）。
