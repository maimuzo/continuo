...
（載せることと Status は [docs/plans/continuo_design.md:9801](../../docs/plans/continuo_design.md#L9801)、
並べ替えは [docs/plans/continuo_design.md:9988-9992](../../docs/plans/continuo_design.md#L9988-L9992) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9807](../../docs/plans/continuo_design.md#L9807)）。
...
（[docs/plans/continuo_design.md:9799-9811](../../docs/plans/continuo_design.md#L9799-L9811)）。
...
（[docs/plans/continuo_design.md:9802](../../docs/plans/continuo_design.md#L9802) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9845](../../docs/plans/continuo_design.md#L9845) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9847](../../docs/plans/continuo_design.md#L9847)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9803](../../docs/plans/continuo_design.md#L9803) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9847](../../docs/plans/continuo_design.md#L9847)）。
