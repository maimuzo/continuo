...
（載せることと Status は [docs/plans/continuo_design.md:9964](../../docs/plans/continuo_design.md#L9964)、
並べ替えは [docs/plans/continuo_design.md:10151-10155](../../docs/plans/continuo_design.md#L10151-L10155) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9970](../../docs/plans/continuo_design.md#L9970)）。
...
（[docs/plans/continuo_design.md:9962-9974](../../docs/plans/continuo_design.md#L9962-L9974)）。
...
（[docs/plans/continuo_design.md:9965](../../docs/plans/continuo_design.md#L9965) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:10008](../../docs/plans/continuo_design.md#L10008) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:10010](../../docs/plans/continuo_design.md#L10010)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9966](../../docs/plans/continuo_design.md#L9966) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:10010](../../docs/plans/continuo_design.md#L10010)）。
