...
（載せることと Status は [docs/plans/continuo_design.md:9066](../../docs/plans/continuo_design.md#L9067)、
並べ替えは [docs/plans/continuo_design.md:9253-9257](../../docs/plans/continuo_design.md#L9254-L9258) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9072](../../docs/plans/continuo_design.md#L9073)）。
...
（[docs/plans/continuo_design.md:9064-9076](../../docs/plans/continuo_design.md#L9065-L9077)）。
...
（[docs/plans/continuo_design.md:9067](../../docs/plans/continuo_design.md#L9068) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9110](../../docs/plans/continuo_design.md#L9111) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9112](../../docs/plans/continuo_design.md#L9113)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9068](../../docs/plans/continuo_design.md#L9069) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9112](../../docs/plans/continuo_design.md#L9113)）。
