...
（載せることと Status は [docs/plans/continuo_design.md:8585](../../docs/plans/continuo_design.md#L8585)、
並べ替えは [docs/plans/continuo_design.md:8772-8776](../../docs/plans/continuo_design.md#L8772-L8776) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8591](../../docs/plans/continuo_design.md#L8591)）。
...
（[docs/plans/continuo_design.md:8583-8595](../../docs/plans/continuo_design.md#L8583-L8595)）。
...
（[docs/plans/continuo_design.md:8586](../../docs/plans/continuo_design.md#L8586) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8629](../../docs/plans/continuo_design.md#L8629) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8631](../../docs/plans/continuo_design.md#L8631)）。104件の全並べ替えで約2分かかる |
...
| **グループごとの計画** | **そのグループの代表の issue のコメントへ残す**（[docs/plans/continuo_design.md:3379](../../docs/plans/continuo_design.md#L3379) の 3-26） |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8587](../../docs/plans/continuo_design.md#L8587) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
[docs/plans/continuo_design.md:3402-3403](../../docs/plans/continuo_design.md#L3402-L3403) の 3-26 が
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8631](../../docs/plans/continuo_design.md#L8631)）。
