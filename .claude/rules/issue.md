...
（載せることと Status は [docs/plans/continuo_design.md:9314](../../docs/plans/continuo_design.md#L9314)、
並べ替えは [docs/plans/continuo_design.md:9501-9505](../../docs/plans/continuo_design.md#L9501-L9505) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9320](../../docs/plans/continuo_design.md#L9320)）。
...
（[docs/plans/continuo_design.md:9312-9324](../../docs/plans/continuo_design.md#L9312-L9324)）。
...
（[docs/plans/continuo_design.md:9315](../../docs/plans/continuo_design.md#L9315) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9358](../../docs/plans/continuo_design.md#L9358) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9360](../../docs/plans/continuo_design.md#L9360)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9316](../../docs/plans/continuo_design.md#L9316) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9360](../../docs/plans/continuo_design.md#L9360)）。
