...
（載せることと Status は [docs/plans/continuo_design.md:9444](../../docs/plans/continuo_design.md#L9444)、
並べ替えは [docs/plans/continuo_design.md:9631-9635](../../docs/plans/continuo_design.md#L9631-L9635) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9450](../../docs/plans/continuo_design.md#L9450)）。
...
（[docs/plans/continuo_design.md:9442-9454](../../docs/plans/continuo_design.md#L9442-L9454)）。
...
（[docs/plans/continuo_design.md:9445](../../docs/plans/continuo_design.md#L9445) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9488](../../docs/plans/continuo_design.md#L9488) の 4-2）。
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9446](../../docs/plans/continuo_design.md#L9446) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:4331](../../docs/plans/continuo_design.md#L4331)）。
