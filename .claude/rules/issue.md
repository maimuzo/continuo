...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9491](../../docs/plans/continuo_design.md#L9491) の 4-2）。
...
| **グループごとの計画** | **そのグループの代表の issue のコメントへ残す**（[docs/plans/continuo_design.md:3590](../../docs/plans/continuo_design.md#L3590) の 3-26） |
...
[docs/plans/continuo_design.md:3614-3615](../../docs/plans/continuo_design.md#L3614-L3615) の 3-26 が
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:4340](../../docs/plans/continuo_design.md#L4340)）。
