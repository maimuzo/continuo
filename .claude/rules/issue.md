...
（載せることと Status は [docs/plans/continuo_design.md:8596](../../docs/plans/continuo_design.md#L8596)、
並べ替えは [docs/plans/continuo_design.md:8783-8787](../../docs/plans/continuo_design.md#L8783-L8787) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8602](../../docs/plans/continuo_design.md#L8602)）。
...
（[docs/plans/continuo_design.md:8594-8606](../../docs/plans/continuo_design.md#L8594-L8606)）。
...
（[docs/plans/continuo_design.md:8597](../../docs/plans/continuo_design.md#L8597) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8640](../../docs/plans/continuo_design.md#L8640) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8642](../../docs/plans/continuo_design.md#L8642)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8598](../../docs/plans/continuo_design.md#L8598) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8642](../../docs/plans/continuo_design.md#L8642)）。
