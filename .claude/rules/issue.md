...
（載せることと Status は [docs/plans/continuo_design.md:9991](../../docs/plans/continuo_design.md#L9991)、
並べ替えは [docs/plans/continuo_design.md:10178-10182](../../docs/plans/continuo_design.md#L10178-L10182) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9997](../../docs/plans/continuo_design.md#L9997)）。
...
（[docs/plans/continuo_design.md:9989-10001](../../docs/plans/continuo_design.md#L9989-L10001)）。
...
（[docs/plans/continuo_design.md:9992](../../docs/plans/continuo_design.md#L9992) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:10035](../../docs/plans/continuo_design.md#L10035) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:10037](../../docs/plans/continuo_design.md#L10037)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9993](../../docs/plans/continuo_design.md#L9993) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:10037](../../docs/plans/continuo_design.md#L10037)）。
