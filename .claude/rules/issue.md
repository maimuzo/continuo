...
（載せることと Status は [docs/plans/continuo_design.md:9070](../../docs/plans/continuo_design.md#L9451)、
並べ替えは [docs/plans/continuo_design.md:9257-9261](../../docs/plans/continuo_design.md#L9641-L9645) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9076](../../docs/plans/continuo_design.md#L9457)）。
...
（[docs/plans/continuo_design.md:9068-9080](../../docs/plans/continuo_design.md#L9449-L9461)）。
...
（[docs/plans/continuo_design.md:9169](../../docs/plans/continuo_design.md#L9452) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9114](../../docs/plans/continuo_design.md#L9498) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9116](../../docs/plans/continuo_design.md#L9500)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9170](../../docs/plans/continuo_design.md#L9453) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9116](../../docs/plans/continuo_design.md#L9500)）。
