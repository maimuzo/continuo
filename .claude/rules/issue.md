...
（載せることと Status は [docs/plans/continuo_design.md:8573](../../docs/plans/continuo_design.md#L8573)、
並べ替えは [docs/plans/continuo_design.md:8760-8764](../../docs/plans/continuo_design.md#L8760-L8764) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8579](../../docs/plans/continuo_design.md#L8579)）。
...
（[docs/plans/continuo_design.md:8571-8583](../../docs/plans/continuo_design.md#L8571-L8583)）。
...
（[docs/plans/continuo_design.md:8574](../../docs/plans/continuo_design.md#L8574) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8617](../../docs/plans/continuo_design.md#L8617) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8619](../../docs/plans/continuo_design.md#L8619)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8575](../../docs/plans/continuo_design.md#L8575) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8619](../../docs/plans/continuo_design.md#L8619)）。
