...
（載せることと Status は [docs/plans/continuo_design.md:9978](../../docs/plans/continuo_design.md#L9978)、
並べ替えは [docs/plans/continuo_design.md:10165-10169](../../docs/plans/continuo_design.md#L10165-L10169) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9984](../../docs/plans/continuo_design.md#L9984)）。
...
（[docs/plans/continuo_design.md:9976-9988](../../docs/plans/continuo_design.md#L9976-L9988)）。
...
（[docs/plans/continuo_design.md:9979](../../docs/plans/continuo_design.md#L9979) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:10022](../../docs/plans/continuo_design.md#L10022) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:10024](../../docs/plans/continuo_design.md#L10024)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9980](../../docs/plans/continuo_design.md#L9980) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:10024](../../docs/plans/continuo_design.md#L10024)）。
