...
（載せることと Status は [docs/plans/continuo_design.md:9433](../../docs/plans/continuo_design.md#L9433)、
並べ替えは [docs/plans/continuo_design.md:9620-9624](../../docs/plans/continuo_design.md#L9620-L9624) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9439](../../docs/plans/continuo_design.md#L9439)）。
...
（[docs/plans/continuo_design.md:9431-9443](../../docs/plans/continuo_design.md#L9431-L9443)）。
...
（[docs/plans/continuo_design.md:9434](../../docs/plans/continuo_design.md#L9434) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9477](../../docs/plans/continuo_design.md#L9477) の 4-2）。
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9435](../../docs/plans/continuo_design.md#L9435) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:4320](../../docs/plans/continuo_design.md#L4320)）。
