...
（載せることと Status は [docs/plans/continuo_design.md:8623](../../docs/plans/continuo_design.md#L8623)、
並べ替えは [docs/plans/continuo_design.md:8810-8814](../../docs/plans/continuo_design.md#L8810-L8814) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8629](../../docs/plans/continuo_design.md#L8629)）。
...
（[docs/plans/continuo_design.md:8621-8633](../../docs/plans/continuo_design.md#L8621-L8633)）。
...
（[docs/plans/continuo_design.md:8624](../../docs/plans/continuo_design.md#L8624) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8667](../../docs/plans/continuo_design.md#L8667) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8669](../../docs/plans/continuo_design.md#L8669)）。104件の全並べ替えで約2分かかる |
...
| **グループごとの計画** | **そのグループの代表の issue のコメントへ残す**（[docs/plans/continuo_design.md:3446](../../docs/plans/continuo_design.md#L3446) の 3-26） |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8625](../../docs/plans/continuo_design.md#L8625) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
[docs/plans/continuo_design.md:3469-3470](../../docs/plans/continuo_design.md#L3469-L3470) の 3-26 が
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8669](../../docs/plans/continuo_design.md#L8669)）。
