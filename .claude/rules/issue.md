...
（載せることと Status は [docs/plans/continuo_design.md:9752](../../docs/plans/continuo_design.md#L9752)、
並べ替えは [docs/plans/continuo_design.md:9947-9951](../../docs/plans/continuo_design.md#L9947-L9951) の 4-4 の表に
...
（[docs/plans/continuo_design.md:9750-9762](../../docs/plans/continuo_design.md#L9750-L9762)）。
...
（[docs/plans/continuo_design.md:9753](../../docs/plans/continuo_design.md#L9753) の 4-1 の遷移表）。
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9754](../../docs/plans/continuo_design.md#L9754) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
