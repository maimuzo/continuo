...
（載せることと Status は [docs/plans/continuo_design.md:9112](../../docs/plans/continuo_design.md#L9112)、
並べ替えは [docs/plans/continuo_design.md:9299-9303](../../docs/plans/continuo_design.md#L9299-L9303) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9118](../../docs/plans/continuo_design.md#L9118)）。
...
（[docs/plans/continuo_design.md:9110-9122](../../docs/plans/continuo_design.md#L9110-L9122)）。
...
（[docs/plans/continuo_design.md:9113](../../docs/plans/continuo_design.md#L9113) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9156](../../docs/plans/continuo_design.md#L9156) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9158](../../docs/plans/continuo_design.md#L9158)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9114](../../docs/plans/continuo_design.md#L9114) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9158](../../docs/plans/continuo_design.md#L9158)）。
