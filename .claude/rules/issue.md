...
（載せることと Status は [docs/plans/continuo_design.md:8561](../../docs/plans/continuo_design.md#L8561)、
並べ替えは [docs/plans/continuo_design.md:8748-8752](../../docs/plans/continuo_design.md#L8748-L8752) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8567](../../docs/plans/continuo_design.md#L8567)）。
...
（[docs/plans/continuo_design.md:8559-8571](../../docs/plans/continuo_design.md#L8559-L8571)）。
...
（[docs/plans/continuo_design.md:8562](../../docs/plans/continuo_design.md#L8562) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8605](../../docs/plans/continuo_design.md#L8605) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8607](../../docs/plans/continuo_design.md#L8607)）。104件の全並べ替えで約2分かかる |
...
| **グループごとの計画** | **そのグループの代表の issue のコメントへ残す**（[docs/plans/continuo_design.md:3369](../../docs/plans/continuo_design.md#L3369) の 3-26） |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8563](../../docs/plans/continuo_design.md#L8563) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
[docs/plans/continuo_design.md:3392-3393](../../docs/plans/continuo_design.md#L3392-L3393) の 3-26 が
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8607](../../docs/plans/continuo_design.md#L8607)）。
