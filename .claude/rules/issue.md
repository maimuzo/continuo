...
（載せることと Status は [docs/plans/continuo_design.md:9472](../../docs/plans/continuo_design.md#L9472)、
並べ替えは [docs/plans/continuo_design.md:9659-9663](../../docs/plans/continuo_design.md#L9659-L9663) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9478](../../docs/plans/continuo_design.md#L9478)）。
...
（[docs/plans/continuo_design.md:9470-9481](../../docs/plans/continuo_design.md#L9470-L9481)）。
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9474](../../docs/plans/continuo_design.md#L9474) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
[docs/plans/continuo_design.md:3632-3633](../../docs/plans/continuo_design.md#L3632-L3633) の 3-26 が
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:4359](../../docs/plans/continuo_design.md#L4359)）。
