...
（載せることと Status は [docs/plans/continuo_design.md:8558](../../docs/plans/continuo_design.md#L8558)、
並べ替えは [docs/plans/continuo_design.md:8745-8749](../../docs/plans/continuo_design.md#L8745-L8749) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8564](../../docs/plans/continuo_design.md#L8564)）。
...
（[docs/plans/continuo_design.md:8556-8568](../../docs/plans/continuo_design.md#L8556-L8568)）。
...
（[docs/plans/continuo_design.md:8559](../../docs/plans/continuo_design.md#L8559) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8602](../../docs/plans/continuo_design.md#L8602) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8604](../../docs/plans/continuo_design.md#L8604)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8560](../../docs/plans/continuo_design.md#L8560) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8604](../../docs/plans/continuo_design.md#L8604)）。
