...
（載せることと Status は [docs/plans/continuo_design.md:9147](../../docs/plans/continuo_design.md#L9147)、
並べ替えは [docs/plans/continuo_design.md:9334-9338](../../docs/plans/continuo_design.md#L9334-L9338) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9153](../../docs/plans/continuo_design.md#L9153)）。
...
（[docs/plans/continuo_design.md:9145-9157](../../docs/plans/continuo_design.md#L9145-L9157)）。
...
（[docs/plans/continuo_design.md:9148](../../docs/plans/continuo_design.md#L9148) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9191](../../docs/plans/continuo_design.md#L9191) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9193](../../docs/plans/continuo_design.md#L9193)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9149](../../docs/plans/continuo_design.md#L9149) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9193](../../docs/plans/continuo_design.md#L9193)）。
