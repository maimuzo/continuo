...
（載せることと Status は [docs/plans/continuo_design.md:8720](../../docs/plans/continuo_design.md#L8720)、
並べ替えは [docs/plans/continuo_design.md:8905-8912](../../docs/plans/continuo_design.md#L8905-L8912) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8726](../../docs/plans/continuo_design.md#L8726)）。
...
（[docs/plans/continuo_design.md:8718-8730](../../docs/plans/continuo_design.md#L8718-L8730)）。
...
（[docs/plans/continuo_design.md:8721](../../docs/plans/continuo_design.md#L8721) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8764](../../docs/plans/continuo_design.md#L8764) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:3932](../../docs/plans/continuo_design.md#L3932)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8722](../../docs/plans/continuo_design.md#L8722) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:3932](../../docs/plans/continuo_design.md#L3932)）。
