...
（載せることと Status は [docs/plans/continuo_design.md:8753](../../docs/plans/continuo_design.md#L8753)、
並べ替えは [docs/plans/continuo_design.md:8940-8944](../../docs/plans/continuo_design.md#L8940-L8944) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8759](../../docs/plans/continuo_design.md#L8759)）。
...
（[docs/plans/continuo_design.md:8751-8763](../../docs/plans/continuo_design.md#L8751-L8763)）。
...
（[docs/plans/continuo_design.md:8754](../../docs/plans/continuo_design.md#L8754) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8797](../../docs/plans/continuo_design.md#L8797) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8799](../../docs/plans/continuo_design.md#L8799)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8755](../../docs/plans/continuo_design.md#L8755) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8799](../../docs/plans/continuo_design.md#L8799)）。
