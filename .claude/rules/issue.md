...
（載せることと Status は [docs/plans/continuo_design.md:8569](../../docs/plans/continuo_design.md#L8569)、
並べ替えは [docs/plans/continuo_design.md:8756-8760](../../docs/plans/continuo_design.md#L8756-L8760) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8575](../../docs/plans/continuo_design.md#L8575)）。
...
（[docs/plans/continuo_design.md:8567-8579](../../docs/plans/continuo_design.md#L8567-L8579)）。
...
（[docs/plans/continuo_design.md:8570](../../docs/plans/continuo_design.md#L8570) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8613](../../docs/plans/continuo_design.md#L8613) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8615](../../docs/plans/continuo_design.md#L8615)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8571](../../docs/plans/continuo_design.md#L8571) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8615](../../docs/plans/continuo_design.md#L8615)）。
