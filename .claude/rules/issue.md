...
（[internal/prompt/builtin.md:388](../../internal/prompt/builtin.md#L388) は「あなたが `gh` を叩く必要はありません」）。
...
組み込みの指示書（[internal/prompt/builtin.md:804-807](../../internal/prompt/builtin.md#L804-L807) の 7-2）が、
