...
（載せることと Status は [docs/plans/continuo_design.md:9816](../../docs/plans/continuo_design.md#L9816)、
並べ替えは [docs/plans/continuo_design.md:10003-10007](../../docs/plans/continuo_design.md#L10003-L10007) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9822](../../docs/plans/continuo_design.md#L9822)）。
...
（[docs/plans/continuo_design.md:9814-9826](../../docs/plans/continuo_design.md#L9814-L9826)）。
...
（[docs/plans/continuo_design.md:9817](../../docs/plans/continuo_design.md#L9817) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9860](../../docs/plans/continuo_design.md#L9860) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9862](../../docs/plans/continuo_design.md#L9862)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9818](../../docs/plans/continuo_design.md#L9818) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9862](../../docs/plans/continuo_design.md#L9862)）。
