...
（載せることと Status は [docs/plans/continuo_design.md:9088](../../docs/plans/continuo_design.md#L9088)、
並べ替えは [docs/plans/continuo_design.md:9275-9279](../../docs/plans/continuo_design.md#L9275-L9279) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9094](../../docs/plans/continuo_design.md#L9094)）。
...
（[docs/plans/continuo_design.md:9086-9098](../../docs/plans/continuo_design.md#L9086-L9098)）。
...
（[docs/plans/continuo_design.md:9089](../../docs/plans/continuo_design.md#L9089) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9132](../../docs/plans/continuo_design.md#L9132) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9134](../../docs/plans/continuo_design.md#L9134)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9090](../../docs/plans/continuo_design.md#L9090) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9134](../../docs/plans/continuo_design.md#L9134)）。
