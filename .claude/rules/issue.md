...
（載せることと Status は [docs/plans/continuo_design.md:8625](../../docs/plans/continuo_design.md#L8625)、
並べ替えは [docs/plans/continuo_design.md:8812-8816](../../docs/plans/continuo_design.md#L8812-L8816) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:8631](../../docs/plans/continuo_design.md#L8631)）。
...
（[docs/plans/continuo_design.md:8623-8635](../../docs/plans/continuo_design.md#L8623-L8635)）。
...
（[docs/plans/continuo_design.md:8626](../../docs/plans/continuo_design.md#L8626) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8669](../../docs/plans/continuo_design.md#L8669) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8671](../../docs/plans/continuo_design.md#L8671)）。104件の全並べ替えで約2分かかる |
...
| **グループごとの計画** | **そのグループの代表の issue のコメントへ残す**（[docs/plans/continuo_design.md:3448](../../docs/plans/continuo_design.md#L3448) の 3-26） |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8627](../../docs/plans/continuo_design.md#L8627) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
[docs/plans/continuo_design.md:3471-3472](../../docs/plans/continuo_design.md#L3471-L3472) の 3-26 が
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8671](../../docs/plans/continuo_design.md#L8671)）。
