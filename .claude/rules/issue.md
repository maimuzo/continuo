...
（載せることと Status は [docs/plans/continuo_design.md:10052](../../docs/plans/continuo_design.md#L10052)、
並べ替えは [docs/plans/continuo_design.md:10242-10246](../../docs/plans/continuo_design.md#L10242-L10246) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:10058](../../docs/plans/continuo_design.md#L10058)）。
...
（[docs/plans/continuo_design.md:10050-10062](../../docs/plans/continuo_design.md#L10050-L10062)）。
...
（[docs/plans/continuo_design.md:10053](../../docs/plans/continuo_design.md#L10053) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:10099](../../docs/plans/continuo_design.md#L10099) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:10101](../../docs/plans/continuo_design.md#L10101)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:10054](../../docs/plans/continuo_design.md#L10054) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:10101](../../docs/plans/continuo_design.md#L10101)）。
