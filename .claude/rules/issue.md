...
（載せることと Status は [docs/plans/continuo_design.md:9947](../../docs/plans/continuo_design.md#L9947)、
並べ替えは [docs/plans/continuo_design.md:10137-10141](../../docs/plans/continuo_design.md#L10137-L10141) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9953](../../docs/plans/continuo_design.md#L9953)）。
...
（[docs/plans/continuo_design.md:9945-9957](../../docs/plans/continuo_design.md#L9945-L9957)）。
...
（[docs/plans/continuo_design.md:9948](../../docs/plans/continuo_design.md#L9948) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9994](../../docs/plans/continuo_design.md#L9994) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9996](../../docs/plans/continuo_design.md#L9996)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9949](../../docs/plans/continuo_design.md#L9949) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9996](../../docs/plans/continuo_design.md#L9996)）。
