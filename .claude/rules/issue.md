...
（[internal/prompt/builtin.md:406](../../internal/prompt/builtin.md#L406) は「あなたが `gh` を叩く必要はありません」）。
...
組み込みの指示書（[internal/prompt/builtin.md:1038-1060](../../internal/prompt/builtin.md#L1038-L1060) の 7-2）が、
