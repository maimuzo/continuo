...
（[docs/plans/continuo_design.md:8569](../../docs/plans/continuo_design.md#L8569)）。
...
（[docs/plans/continuo_design.md:8561-8573](../../docs/plans/continuo_design.md#L8561-L8573)）。
...
（[docs/plans/continuo_design.md:8564](../../docs/plans/continuo_design.md#L8564) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:8607](../../docs/plans/continuo_design.md#L8607) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:8609](../../docs/plans/continuo_design.md#L8609)）。104件の全並べ替えで約2分かかる |
...
| **グループごとの計画** | **そのグループの代表の issue のコメントへ残す**（[docs/plans/continuo_design.md:3371](../../docs/plans/continuo_design.md#L3371) の 3-26） |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:8565](../../docs/plans/continuo_design.md#L8565) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
[docs/plans/continuo_design.md:3394-3395](../../docs/plans/continuo_design.md#L3394-L3395) の 3-26 が
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:8609](../../docs/plans/continuo_design.md#L8609)）。
