...
（載せることと Status は [docs/plans/continuo_design.md:9676](../../docs/plans/continuo_design.md#L9676)、
並べ替えは [docs/plans/continuo_design.md:9863-9867](../../docs/plans/continuo_design.md#L9863-L9867) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9682](../../docs/plans/continuo_design.md#L9682)）。
...
（[docs/plans/continuo_design.md:9674-9686](../../docs/plans/continuo_design.md#L9674-L9686)）。
...
（[docs/plans/continuo_design.md:9677](../../docs/plans/continuo_design.md#L9677) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9720](../../docs/plans/continuo_design.md#L9720) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9722](../../docs/plans/continuo_design.md#L9722)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9678](../../docs/plans/continuo_design.md#L9678) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9722](../../docs/plans/continuo_design.md#L9722)）。
