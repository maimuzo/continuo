...
（載せることと Status は [docs/plans/continuo_design.md:9919](../../docs/plans/continuo_design.md#L9919)、
並べ替えは [docs/plans/continuo_design.md:10109-10113](../../docs/plans/continuo_design.md#L10109-L10113) の 4-4 の表に
「continuo が起動したエージェント」の行が無いこと）。
**ただし「1バイトも触らない」ではない。**設計は、そのエージェントが自分で `gh` を叩いて
`In Progress` → `Blocked` を動かす経路を認めている
（[docs/plans/continuo_design.md:9925](../../docs/plans/continuo_design.md#L9925)）。
...
（[docs/plans/continuo_design.md:9917-9929](../../docs/plans/continuo_design.md#L9917-L9929)）。
...
（[docs/plans/continuo_design.md:9920](../../docs/plans/continuo_design.md#L9920) の 4-1 の遷移表）。
...
**段4 の並び順は、`updateProjectV2ItemPosition` で動かす**（[docs/plans/continuo_design.md:9966](../../docs/plans/continuo_design.md#L9966) の 4-2）。
...
| 何を | なぜ |
| --- | --- |
| **書き込みの間は1秒空ける** | GitHub が変更を伴うリクエストに求めている（[docs/plans/continuo_design.md:9968](../../docs/plans/continuo_design.md#L9968)）。104件の全並べ替えで約2分かかる |
...
| **3** | **AI** | **グループの代表以外のうち、`Ready` か `In Progress` に在るものを `Ice Box` へ落とす**（[docs/plans/continuo_design.md:9921](../../docs/plans/continuo_design.md#L9921) の 4-1 の遷移表）。`updateProjectV2ItemFieldValue` を叩く |
...
**書き込みの間は1秒空ける**（[docs/plans/continuo_design.md:9968](../../docs/plans/continuo_design.md#L9968)）。
