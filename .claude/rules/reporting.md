...
**「訂正します」と書いた回数は34回。**返答の総数は1623。

**内訳の合計は47で、34より多い。**
**上の表は原因の数であって、訂正の数ではない。**1つの訂正に原因が2つ以上あったものがある。
**34と47を足し引きしてはならない。**

**数え方は記録していない。**残っているのは「1つのセッションの記録を機械で数えた」という一文だけで、
**検索パターンも、対象のパスも、対象の commit も残っていない。**
**この節が他人に求めている3点を、この数値自身は満たしていない。**
**だからこの5つは、原因の大きさの順として読む。**
**比率を別のセッションへ当てはめてはならない。**
