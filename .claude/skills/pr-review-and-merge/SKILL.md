...
**3・6・9回目に通す6段の手順**、**「収まっている」の定義と、収まったあとに何周回すか**
（どれも [CLAUDE.md](../../../CLAUDE.md) の「回数を数える」にある）。

**収まっていて、かつ最後の1周も終えていたら、段5へ進む。**
**収まっていないあいだと、最後の1周が残っているあいだは、段5へ進まない。**
**何をもって終えたとするかは、上で指した「収まったあと、何周回すか」が決める。**
3・6・9回目で収まらないときは、CLAUDE.md の「回数を数える」にある6段を通してから、次の周を回す。
**人間の判断は待たない。連続10回で収まらなかったら、段5へ進まずに止まる**
（[CLAUDE.md](../../../CLAUDE.md) の「絶対条件：3回ごとに issue と実装を突き合わせ直す。連続10回で完全に止まる」）。

**段5へ進んだら、段6 も飛ばさない。**マージしてよいかを決めるのは、段6 で見る `MERGEABLE/CLEAN` だけである。
