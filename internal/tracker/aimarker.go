...
// **関門の案内だけは、投稿する形で印が2行並ぶ。**その2行は `self_marker` と `continuo:gated:*` で、
// **`self_marker` は `ComposeCommentBody` があとから1行目として前へ足す。**
// **だから `withAIMarker` へ来る時点では、1行目が `continuo:gated:*` の1本だけである。**
//
