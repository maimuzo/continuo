...
// knownStates は continuo が意味を知っている Status 名をすべて返す（設計 3-49）。
//
...
// isKnownState は continuo がその Status の意味を知っているかを返す（設計 3-49）。
//
// state: 判定する Status 名。
...
// unknownStateReason は知らない Status で止めたことを人間へ伝える文面を作る（設計 3-49）。
//
// **3つを必ず書く。**
//
