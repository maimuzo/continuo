...
<!-- issue のコメント・pull request の本文・commit メッセージ・コードのコメントを -->
<!-- 何語で書かせるかを書いてください。書かなければエージェントの既定に任されます。 -->
<!-- 例: すべて日本語で書いてください。技術用語は英語のまま使ってください -->
<!--     （worktree / branch / commit / pane / hook など）。日本語に直訳しないでください。 -->
