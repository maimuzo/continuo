...
<!-- 消しても、まとめて直したときの手順は組み込みの側に残ります（表明の書き方と、 -->
<!-- 直した issue ごとにその issue へ書かせる段）。まとめて直さなければ使われません。 -->
<!-- ただし、確実に止まるとは言えません。グループの計画は代表の issue のコメント側にも -->
<!-- 書かれているので、消したときにどう振る舞うかは測っていません。 -->
