...
//
// **front matter だけである。本文は持たない**（設計 5-3c）。
// **送るプロンプトは continuo の実行ファイルの中にある**（internal/prompt/builtin.md）。
// 利用者が書き足すぶんは PROJECT_SPECIFIC_PROMPT.md へ置く。
// **本文をここに戻してはならない。**戻すと continuo が仕組みの説明を直しても、
