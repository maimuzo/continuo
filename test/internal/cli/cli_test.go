...
//
// **`continuo init` が置くのは WORKFLOW.md の1枚である**（設計 5-3g）。
//
// **かつて2枚を置いていた頃の注釈が、ここに残っていた**（commit a4e984c が
// PROJECT_SPECIFIC_PROMPT.md を2枚目に置き、そのあと1枚へ戻された）。
// **戻したときに注釈だけが残り、「2枚を置くようになった」と嘘を書いたまま緑だった。**
// **コードと整合していないテストは、読む人を誤らせるので置かない。**
//
