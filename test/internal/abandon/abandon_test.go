// {"RUCM-CFG-SHA256": "426895d3aada39c7a5513ae822c83e7d5fbb425ba58f79d460b9d340e79dddb4", "SOURCE": "docs/spec/usecases/particular_case/着手を取り消す.cfg.json"}
//
...
// 「手を離させる書き込みを行う」は基本フローの入り口で1度だけ判定され、以降の段は
