...
//
// **設定に名前の無い Status へ動かされたときの検査である**（設計 3-49 / 3-50）。
//
...
// {"RUCM-PATH": "P013"}
//
// TestRUCMHandoff_P013_知らないStatusで止めるときはissueに理由を書く は、設計 3-49 を確かめる。
//
...
// {"RUCM-PATH": "P014"}
//
// TestRUCMHandoff_P014_turnが動いている間は知らないStatusでもすぐには止めない は、設計 3-49 を確かめる。
//
...
// TestStopWorker_自分で止めた直後のturnの失敗をWARNにしない は、設計 3-50 を確かめる。
//
...
// TestStopWorker_止めたらherdrの待ち受けの中のturnループも解ける は、設計 3-50 を確かめる。
//
