...
- **レビューは最大3回。**3回で収まらなければ、下の「3回で通らなかったとき」へ入る。**設計レビューと実装レビューをそれぞれ別に数え、どちらかが連続10回に達したら止まって人間に方針を確認する。人間が方針を変えたら数え直す**
...
**どちらかが連続10回に達したら、そこで止めて人間に方針を確認する。**
**人間が方針を変えたら、そこから数え直す。**
...
**足して20回まで、という意味ではない。**
**どちらか一方が10回に達した時点で止まり、人間に方針を確認する。**
