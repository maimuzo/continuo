...
| **収まった。Medium と Low を直さないと決めた** | どの回でも | **そこで終わり** |
| **収まった。Medium か Low を直した** | **10回目** | **そこで終わり。11回目は無い** |
| **収まった。Medium か Low を直した** | それ以外 | **最後に1回だけ回す。**その周も10回に数える |

**最後の1回でも収まっていれば、指摘があってももう直さない。**4行目に当たる。

**Medium と Low を直すかどうかの判断は、上の「対応表の列」の下にある「Critical と High は直す」の2行に従う。**
**ただし最後の周では、この表の4行目が優先する。**
