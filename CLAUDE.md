...
| 回 | 収まっていないときに、どうするか |
| --- | --- |
| 1回目のあと | **下の6段を通し、直して2回目を回す。**人間に訊かない |
| 2回目のあと | **1回目と同じ。**人間に訊かない |
| **3〜9回目のあと** | **下の6段を通す**（収まっていれば、そもそもこの表を読まない） |
...
| --- | --- |
| **毎周のあと** | **上の6段を通す**（収まっていれば、そもそもこの表を読まない）。判定は敵対的レビュワーが行い、人間へは経緯を報告する |
