...
- **レビュワーには1回で全部挙げさせ、根拠を否定できるなら直さない。**徹底の度合いと根拠の書き方は [.claude/skills/worker-briefing/SKILL.md](.claude/skills/worker-briefing/SKILL.md) の 2-6 にある
...
| **分類** | **その指摘が「前の周に既に在ったもの」か「前の周の直しが持ち込んだもの」か**（[.claude/skills/worker-briefing/SKILL.md](.claude/skills/worker-briefing/SKILL.md) の 2-6。1周目は空欄でよい） |
