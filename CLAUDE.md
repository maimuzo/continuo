...
**別なのは数え方と、終わったあとに進む先だけである**（数え方は下の「設計レビューと実装レビューは、別々に数える」）。
...
**どちらの場合も、最後の周のレビュー結果と対応表を貼ってから進む。**
...
**設計に触るものだけは、最後の周でも follow-up の issue へ切り出す。**
**切らないと、その指摘はどこにも残らない。**そこだけは上の「Critical と High は直す」がそのまま効く。
...
| **3回目のあと** | **収まっていれば、上の「収まったあと、何周回すか」へ。収まっていなければ、下の6段を通す** |
| 4・5回目のあと | **直して次を回す。**何もしない |
| **6回目のあと** | **3回目と同じ。収まっていれば上の「収まったあと、何周回すか」へ。収まっていなければ、下の6段を通す** |
| 7・8回目のあと | **直して次を回す。**何もしない |
| **9回目のあと** | **3回目と同じ。収まっていれば上の「収まったあと、何周回すか」へ。収まっていなければ、下の6段を通す** |
| **10回目のあと** | **収まっていれば、Medium と Low を直さずにそこで終える**（11回目は無い）**。収まっていなければ止まる。**下の絶対条件を見よ |

**収まったあとの「最後の1回」も、この10回に数える。**
**10回目で初めて収まったなら、そこで終わる。**Medium と Low を直して11回目を回してはならない。
...
| **3・6・9回目のあと** | **収まっていれば、上の「収まったあと、何周回すか」へ。****収まっていなければ、上の6段を通す。**判定は敵対的レビュワーが行い、人間へは経緯を報告する |
