...
| **範囲外で直さない（対象が違うので矛盾ではなく差）** | [internal/prompt/builtin.md:232](../../../../internal/prompt/builtin.md#L232) の見本「直さない \| この issue の範囲外」（Low） | [CLAUDE.md:545-546](https://github.com/maimuzo/continuo/blob/f86a4acdc006029c1a61b058ccd728c54ba9cb0d/CLAUDE.md#L545-L546)「設計に触るなら follow-up の issue へ切り出す。」。**利用者向けには、follow-up を切り出す指示が無い** |
