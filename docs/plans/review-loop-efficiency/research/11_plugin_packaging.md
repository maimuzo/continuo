...
| **[~/Sources/github/continuo/CLAUDE.md:543-770](../../../../CLAUDE.md#L543-L770)**（228行・16,638バイト。収まっている定義／最大1周／3・6・9／連続10回／敵対的レビュー判定後） | **continuo 固有の語が1つも要らない手順である。**メインエージェントが辿るもので、`/code-review` へ届ける必要が無い |
...
| 何（行数） | なぜ残すか |
| --- | --- |
| **[~/Sources/github/continuo/CLAUDE.md:394-542](../../../../CLAUDE.md#L394-L542)**（149行。PR の手順・3箇所の機械・数える条件・対応表の列） | **目印の決まりそのものである。**`CONTINUO_ALLOW_UNREVIEWED_MERGE` も `check-release-ready` もここにしか無い |
...
| **[~/Sources/github/continuo/.claude/skills/pr-review-and-merge/SKILL.md](../../../../.claude/skills/pr-review-and-merge/SKILL.md)**（310行） | `block-merge-without-review.py` と `review-gate.yml` と目印を名指しする。**`code-review-result` を含む行が多く、目印を引数にしない限り持ち出せない** |
...
| [~/Sources/github/continuo/CLAUDE.md:394-770](../../../../CLAUDE.md#L394-L770) | 377 | 28,326 |
...
| 何を移すか | 減る行数 |
| --- | --- |
| [~/Sources/github/continuo/CLAUDE.md:543-770](../../../../CLAUDE.md#L543-L770) | 228 |
...
| `block-merge-without-review` | 2 | CLAUDE.md・pr-review-and-merge |
| `CONTINUO_ALLOW_UNREVIEWED_MERGE` | 1 | CLAUDE.md のみ |
