...
内訳は、古い決まりを直した 2件、移した部分を消した 37件、移した部分を消した・古い決まりを直した 7件、触れていない 78件 である。丸ごと消したものは無い。
...
| feedback_agent_review_response_format | 移した部分を消した・古い決まりを直した | 組み込みの指示書（5-6・5-7）／CLAUDE.md／`general-claude-md` |
| feedback_always_explain_with_sequence_diagrams | 移した部分を消した | `general-claude-md` |
| feedback_always_record_to_plan_file | 移した部分を消した | CLAUDE.md／`docs-standard`／`general-claude-md` |
| feedback_always_write_issue_pr_title_verbatim | 移した部分を消した | `chat-response`／CLAUDE.md |
...
| feedback_check_overfit_after_many_reviews | 移した部分を消した・古い決まりを直した | 組み込みの指示書（5-6・5-7） |
| feedback_check_plan_and_history_first | 触れていない | ― |
| feedback_check_primary_source_first | 触れていない | ― |
| feedback_check_reply_before_sending | 移した部分を消した | `chat-response` |
...
| feedback_compare_and_recommend_never_decide | 移した部分を消した・古い決まりを直した | `general-claude-md`／`chat-response` |
...
| feedback_file_path_markdown_link | 移した部分を消した | `chat-response` |
...
| feedback_hand_the_human_a_one_liner | 移した部分を消した | `chat-response` |
...
| feedback_parallel_by_default | 移した部分を消した・古い決まりを直した | `general-claude-md` |
| feedback_plan_file_holds_decisions_not_history | 移した部分を消した | `docs-standard` |
| feedback_pr_draft_only_when_blocked | 古い決まりを直した | ― |
| feedback_prove_fixes_landed_in_the_commit | 触れていない | ― |
| feedback_public_repo_only_clean_artifacts | 移した部分を消した | CLAUDE.md |
...
| feedback_research_agents_are_read_only | 移した部分を消した | `chat-response`／`chat-response` の `worker-rules.md`／CLAUDE.md |
| feedback_review_failures_mean_bad_design | 移した部分を消した | 組み込みの指示書（5-6・5-7） |
| feedback_review_loop_is_a_checkin_not_a_quota | 触れていない | ― |
| feedback_review_loop_max_three | 移した部分を消した・古い決まりを直した | 組み込みの指示書（5-6・5-7）／CLAUDE.md／`chat-response` |
| feedback_review_scope_not_only_diff | 移した部分を消した | 組み込みの指示書（5-6・5-7） |
| feedback_review_the_design_before_implementing | 移した部分を消した | 組み込みの指示書（5-6・5-7）／CLAUDE.md |
...
| feedback_worker_context_both_sides | 移した部分を消した | `chat-response` の `worker-rules.md`／`chat-response`／CLAUDE.md |
...
| project_all_issues_on_board | 移した部分を消した | CLAUDE.md |
| project_board_scope_frozen | 触れていない | ― |
| project_breaking_changes_are_allowed | 古い決まりを直した | ― |
| project_continuo_halted_until_issue60 | 触れていない | ― |
| project_do_not_touch_kanban_until_told | 触れていない | ― |
| project_issue_group_representative | 移した部分を消した・古い決まりを直した | `general-claude-md`／`issue-management` |
| project_kanban_is_operated_by_ai | 移した部分を消した・古い決まりを直した | `issue-management` |
...
| reference_herdr_080_status_display | 移した部分を消した | CLAUDE.md |
| reference_herdr_api_schema | 触れていない | ― |
| reference_macos_tcc_desktop_blocked | 触れていない | ― |
| reference_projectv2_select_option_reset | 触れていない | ― |
| reference_python39_long_line_tokenizer | 触れていない | ― |
| reference_what_consumes_quota | 移した部分を消した | CLAUDE.md |
