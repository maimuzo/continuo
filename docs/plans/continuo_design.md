...
**それでも投稿してください。**1件も残らないより、2件残るほうがましです。
**2件になったことは、代表へ書く成果報告に1行添えてください。**
...
| いつ | なぜ2件になるか |
| --- | --- |
| **段1 が URL を返したのに、段2a が読み取りに失敗した** | 書き換える先が分からないので、段2b で新しく1件投稿させる。**1件も残らないより、2件残るほうがましである。**2件になったことは、代表へ書く成果報告に1行添えさせる |
