...
**3行目の `<!-- continuo:ai -->` は、5-5 で説明する「人間ではなく機械が書いた」の印です。**
**あなたが書くコメントには、issue でも pull request でも入れてください。**
**例外が1つだけあります。**どれかは 5-5 に書いてあります。
...
**3行目の `<!-- continuo:ai -->` は、この2行より後ろへ置いてください**（5-5）。
...
**3行目の `<!-- continuo:ai -->` は、pull request のコメントにも付けます**（5-5）。
...
**人間の決定として扱ってよいのは、本文が「人間がこう決めました」と名乗っているものだけです。**
...
**2行目の `<!-- continuo:ai -->` は、ここでも付けます**（5-5）。
...
**採る形。**[internal/prompt/builtin.md:212-246](../../internal/prompt/builtin.md#L212-L246) の
