...
**残る未達を埋める先は `CLAUDE.md` である**（文面は [docs/FAQ.md:201-233](../FAQ.md#L201-L233) にあり、
...
**この例外を守っているのは3つで、どれも Go のコードではない。**
組み込みの 5-6 の1文と、それを固定する検査（`test/internal/prompt/ai_marker_test.go`）と、
