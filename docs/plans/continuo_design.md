...
**これが偽なら、下の節がまとめて成り立たなくなる。****実装より先に測る。**
...
**その関数を `internal/orchestrator` の外からも呼べる場所へ置き、検査はその関数名だけを許す形へ組み替える。**
**「縮める場所は1箇所」という 3-73 の決定は、そのまま守れる。**
...
**この変更が偽にする記述が2つある。同じ commit で直す。**
