...
**そのぶん、公開の issue へ第三者が書いた文が `Bash` になる経路は、既定では1層目だけで受けることになる。**
**1層目（立場の札）はエージェントへの指示であって、判定役への指示ではない。**
3層の表が「**読めるままにする。指示として扱わせない**」と書いているとおり、
**第三者が書いた文が会話に載ること自体は、1層目の設計上の前提である。**
...
**したがって、守りは 6-23 の層に戻る。**
**ただし2層目は 2026-09-09 から既定で外してあるので、何も書かずに使い始めた人には2層である**（6-23 の冒頭。issue #259）。
