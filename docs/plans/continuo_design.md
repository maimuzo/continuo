...
**落とすものと、落とさずに補うものが分かれているので、一言では言い表せません。**
...
**あなた自身がファイルを編集するときは、`sed -i` やリダイレクトで上書きせず、
...
**カンバンも、あなたの仕事ではありません。**Status を動かすのは continuo です（3-7）。
...
**採る形。**[internal/prompt/builtin.md:293-327](../../internal/prompt/builtin.md#L293-L327) の
