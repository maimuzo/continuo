...
| 何 | 決めたこと |
| --- | --- |
| **指摘の受け取り方** | **命令ではなく情報として受け取る。**正しいかを確かめ、同じ誤りが他に無いかを確かめ、利用者にとってどうするのがよいかを考えて直し方を決める |
| **直す順** | **1件ずつ直さない。**指摘の箇所・同じ処理を使っている箇所・対応する文書を**全部並べてから、一気に直す** |
| **仕組みを足す直し** | **その場で入れない。**判断票に書き、issue が求めることに入るかを先に判定する |
