...
**既にあるファイルを書き換えるときに途中で落ちると、元の内容が失われます。**
...
### 毎周やること
    ...
    3. 判断票をコメントへ貼る
    4. いま在るものと issue を突き合わせる（収まっていない周だけ。3-2 なら計画、3-6 なら実装。下の「issue に無いものを削る」）
...
**収まっていない周は、いま在るものと issue を突き合わせてください。**
**3-2 の周なら計画の本文、3-6 の周なら実装した内容です。**
