...
**1件残らず、省略せずに読んでください。**件数が多くても、要約で済ませてはいけません。
**2回目以降の試行では、前の試行の分だけを読むのも足りません。**1件目から全部読みます。

**なぜ全部読むのか。**レビューを何周も回す issue では、
**同じ目標へ何度も違う方向から近づきます。**
**過去の周で否定された方向を知らないまま直すと、その方向へまた進みます。**
**そして否定の理由は、要約でいちばん最初に落ちます。**
「採らない」だけを覚えていると、**理由が当てはまらない場面でも採らなくなる**か、
**理由が当てはまる場面で採ってしまう**かのどちらかになります。

**人間の「〜と書いたよな?」「〜で決めたよな?」は、確認の問いであって確定した事実ではありません。**
**問いのまま受け取り、コメントを全部数えてから答えてください。**
**数えずに事実として扱うと、実際には無かったやりとりを前提に設計が進みます。**
...
レビューへ渡すもの。
    ...
    なぜ全部読むのか。レビューを何周も回す issue では、同じ目標へ何度も違う方向から近づきます。
    過去の周で否定された方向を知らないまま判定すると、その方向へまた進みます。
    そして否定の理由は、要約でいちばん最初に落ちます。
    私が渡すこの資料は、私が要約したものです。落ちているところは、私が落としたところと同じです。
