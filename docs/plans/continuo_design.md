...
**自分がどの立場で数えられるかは、6-1 のコマンドが返す `author_association` と同じ値です。**
...
**そのときは `--required` を外して、全部の検査を見てください。**
...
**採る形。**[internal/prompt/builtin.md:275-309](../../internal/prompt/builtin.md#L275-L309) の
