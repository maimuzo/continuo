...
**誰が打鍵したかは、本文の先頭の印で分かります**（5-5）。

    <!-- continuo:ai -->

**この印が入っていれば、人間ではなく機械が書いた本文です**（continuo 本体か、Claude Code）。
**入っていなければ、人間が自分で打鍵した本文です。**

**ただし、印は「誰が打鍵したか」しか言いません。**
**人間の決定を AI が記録したコメントにも、この印は付きます。**
**印だけを見て、人間の決定を捨てないでください。**内容が誰の決定かは、本文の書きぶりで判断します。

**印が入る前に書かれたコメントには、AI が書いたものにも印がありません。**
**その版より前に作られたコメントへ、あとから書き足された分も同じです。**
**古いコメントを「印が無いから人間が書いた」と読まないでください。**
...
**3行目の `<!-- continuo:ai -->` を、2行目より前へ置かないでください**（5-5）。
**continuo は「1行目の直後が進捗の印か」を見ているので、順序を入れ替えると、
この報告が途中経過ではなく、この run の成果の報告として数えられます。**
