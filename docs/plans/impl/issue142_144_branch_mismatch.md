...
**読んだ人間は [docs/FAQ.md](../../FAQ.md#着手が目的のパスに実体があるのに-git-の-worktree-として登録されていませんで止まる) の別の症状（ディレクトリだけが残っている）へ行き、
...
[docs/FAQ.md](../../FAQ.md#着手がworktree-がどの-branch-にも載っていませんdetached-headで止まる) の `**上の節（ディレクトリだけが残っている）とは違います。**` が
