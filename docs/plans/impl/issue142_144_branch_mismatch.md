...
- `TestTemplate_雛形の本文が設計5_3の本文と一致する`（[docs/plans/continuo_design.md:8880-8881](../continuo_design.md#L8880-L8881) が名指ししている）
...
[internal/orchestrator/dispatch.go:1056](../../../internal/orchestrator/dispatch.go#L1056) の `Base: prepared.Base.String()` から
