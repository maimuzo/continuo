...
10. システムは VALIDATES THAT ボードの issue の Status が terminal_states にも failure_state にも入っていない。
...
flowchart TD
    ...
    B10{"10. VALIDATES THAT Status が terminal_states にも failure_state にも入っていない"}
