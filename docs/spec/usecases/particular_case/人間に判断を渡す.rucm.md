...
- `internal/orchestrator/runstate.go` の `rewriteClaim`、`claimAutomatedRewrite`、`noteAutomatedRewriteFailure`、`noteAutomatedRewriteHandoff`、`beginTerminal`、`endTerminal`
- `internal/config/validate.go` の `validateAutomatedStateRewrite`
- `internal/config/states.go` の `KnownStates`、`AutomatedRewriteTargets`、`StatesNamedInConfig`
