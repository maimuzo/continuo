...
34.   システムは VALIDATES THAT worktree を作業ディレクトリに持つ pane が1つも無いか、herdr へ問い合わせられずかつ利用者が force を指定している。
35. ENDIF
...
flowchart TD
    ...
    B34{"34. VALIDATES THAT pane が1つも無いか herdr へ問い合わせられず force を指定している"}
    B35["35. ENDIF"]
