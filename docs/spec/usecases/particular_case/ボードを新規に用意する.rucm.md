...
> **これは人間が GitHub の画面と `gh` で行う手順の記録である。continuo の仕様ではない。**
>
> **continuo にボードを作る機能は無い。**[README.ja.md](../../../../README.ja.md) と
> [docs/trying_it_out.md](../../../trying_it_out.md) のとおり、**continuo は既にあるカンバンに
> 後から足して使う。**足りない Status の選択肢があるときだけ、人間が GitHub の画面で足す。
>
> **したがって、この記述からテストコードは作らない。**
