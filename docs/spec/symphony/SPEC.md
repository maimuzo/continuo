<!--
  This file is an unmodified copy of SPEC.md from https://github.com/openai/symphony
  (retrieved 2026-08-14), redistributed here under the Apache License, Version 2.0.

  Copyright the openai/symphony authors.
  ...
  The full license text is also available at LICENSE-APACHE-2.0.txt in this
  repository's root. Unless required by applicable law or agreed to in writing,
