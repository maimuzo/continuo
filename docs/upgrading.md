...
| **進捗報告の間隔を、設定から変えられるようになりました** | **要りません。**既定は1時間で、v0.1.13 と同じです（下の節） |
...
**変えられるのは3つだけです。**`WORKFLOW.md` の本文に書くと、組み込みより優先されます。
...
### 進捗報告の間隔を、設定から変えられるようになりました — 既定は1時間のままです
