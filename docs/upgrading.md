...
| 3の別の道 | **2台が同じ巡回で締め切りを跨いだときは、両方が担当者を書きます。アカウントが別なので、担当者が2人になります**（段4へ続きます） |
| 4 | **担当者が2人になったときは、両方が hold を書き、両方が着手します。**branch 名は issue から決まるので同じ名前になり、**片方の push が通りません** |
| 5 | **走り出した2つの作業は、そのままどちらも続きます。**担当者に自分が混じっているあいだ、continuo は「担当は自分のまま」と読むためです。**ダッシュボードにも出ません** |
| 6 | **両方の作業が終わったあとは、その issue に新しく着手されなくなります。**担当者が2人のままだからです。**あなたが担当者を外すまで戻りません。**issue には何も書かれず、ログとダッシュボードにだけ出ます |
