...
| **相手のコードや配布物を変える操作には、免除が及びません** | 他のリポジトリへの push、パッケージの公開、pull request の取り込みと却下（merge・close）、release の作成、ラベルや担当者の付け外しです。**免除の文にも「及ばない」と書いてあります。**いまの作業と関係があるかどうかで、これまでどおり判断します |
