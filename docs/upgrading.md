...
| 4 | `## テストの走らせ方` |
| 5 | `## まとめて直してよい範囲` |
| 6 | `## 実装を始める前に、計画をレビューしてください` |
| 7 | `## PR の決まり` |
| 8 | `## PR を作ったら、レビューしてください` |

**`## 書く言語` を上へ動かしたのは、**下の2つの節がどちらもエージェントに
issue のコメントを書かせる節だからです。**いちばん下に置くと、
何語で書くかを知らないままコメントの書き方を読むことになります。**

**これは `continuo init` が置く雛形の並びです。**
**既に `WORKFLOW.md` を持っている人が、並べ直す必要はありません。**
**本文はあなたのものです。**気になったときに動かしてください。
