...
**設定のキーはありません。**あなたが書くところはどこにもなく、消しても増やしても continuo は見ません。

**副作用が1つあります。**担当者が古いコメントを1文字直しただけでも、18時間の時計は振り出しに戻ります。
**落ちた機械が抱えた issue で、その担当者と同じアカウントの人が古いコメントを編集すると、
別の機械が拾い直すのがその分だけ遅れます。**
**新しいコメントを1件書いたときも同じことが起きます**ので、いままでと同じ種類の遅れです。
